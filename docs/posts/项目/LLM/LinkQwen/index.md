...
[LinkQwen](https://github.com/chuoer47/LinkQwen3.5) —— 我的 Qwen3.5 复现项目:个人可读、可跑、可对照的完整教程,从 MLP、归一化、位置编码、注意力等基础组件,到 MiniQwen 组装、预训练、权重适配、后训练(SFT/DPO/GRPO/PPO)、再到自己手写 vLLM 推理引擎。
