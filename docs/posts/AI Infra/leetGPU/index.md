...
- [Medium Kernel](./Medium-kernel.md) — 金字塔归约 Reduction、online softmax 全局版（含 per-block 翻车实录）、一行一 warp 的 Softmax Attention（FA 教学版）、2D Convolution（kernel 常驻 smem 与 halo 分块两版对照）
