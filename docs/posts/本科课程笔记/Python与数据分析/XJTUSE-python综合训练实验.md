...
![](./XJTUSE-python综合训练实验.assets/image-001-c161c5061d.png)
...
![](./XJTUSE-python综合训练实验.assets/image-002-106c594cf9.png)
...
![](./XJTUSE-python综合训练实验.assets/image-003-6b7954cadf.png)
...
![](./XJTUSE-python综合训练实验.assets/image-004-8de27c8f95.png)
...
![](./XJTUSE-python综合训练实验.assets/image-005-2551ac8d90.png)
...
![](./XJTUSE-python综合训练实验.assets/image-006-5cc9d105d9.png)

可以看到，重点分布在住宅区得多，下面是部分统计分析。

![](./XJTUSE-python综合训练实验.assets/image-007-1bd3a3973e.png)
...
![](./XJTUSE-python综合训练实验.assets/image-008-a5a6849ac3.png)
...
![](./XJTUSE-python综合训练实验.assets/image-009-09e0e08962.png)
...
![](./XJTUSE-python综合训练实验.assets/image-010-287963a177.png)

![](./XJTUSE-python综合训练实验.assets/image-011-0f53d27e1b.png)

#### 5.3 代码
与 PPT 上的相差无几，就是多录入几个变量。核心代码如下：

![](./XJTUSE-python综合训练实验.assets/image-012-a692f3176b.png)

得到的参数如下：

![](./XJTUSE-python综合训练实验.assets/image-013-5060c0d5c2.png)
...
![](./XJTUSE-python综合训练实验.assets/image-014-82d0d88ae4.png)

2.模型评估结果

![](./XJTUSE-python综合训练实验.assets/image-015-894588132e.png)

3.预测图

![](./XJTUSE-python综合训练实验.assets/image-016-1a4811d89b.png)
