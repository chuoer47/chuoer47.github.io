...
![](https://i-blog.csdnimg.cn/blog_migrate/ccedafb0551d1200cbfba09bc8ac64e2.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/d846032b1364d5dd1dd6116d0b67ee24.png)

(如图为P3的处理，P1口的处理与其相同)

键盘帮助我们进行数据的输入，显示器用于相关信息的输出，为了实现多种功能，我们还需要其他的输出进行调控，这里我们使用了P2I，即P2口的输入。 P2的多位数值能够根据我们的需要随时修改为0或1。

![](https://i-blog.csdnimg.cn/blog_migrate/84ba5c9c44a49a4478d3ae22338913df.png)

这样我们还剩下一个P1口没有使用，P1可以帮助我们完成lcd显示的相关工作，还可以帮助完成蜂鸣器的发声。

![](https://i-blog.csdnimg.cn/blog_migrate/bfbc553fa12f18c36b4f74c2ff3d3f88.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/19244720fbbc8a485529ff68edcbb7ce.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/8aceac7ee6c61e5dd7472cf5e2680e97.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/eacc3a19b00da1b634d3c3d0743064fe.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/c73665df1816f10dd1dcd2c6fdee70a8.png)

在这个界面下，根据提示，我们需要使用4*4键盘输入我们设定密码的位数，数值必须在1~8以内，如果输入在这之外的数字是无效的，不会进入下一步。

我们这里输入数字2

![](https://i-blog.csdnimg.cn/blog_migrate/8f580134c800d2ac0a20e11ab0bc3f58.png)

这时候就需要我们设定密码了，默认密码的每一位都是0，我们这里没有进行改动。

使用左侧键6提交我们的初始密码，我们就能够进入我们程序的主要界面，并且刷新。

![](https://i-blog.csdnimg.cn/blog_migrate/e68091b691d9a81a580ddfa23888cc85.png)

![](https://i-blog.csdnimg.cn/blog_migrate/76cc3c708f12092495d89f944713374e.png)

那么我们先尝试一下提交密码，看看是什么结果

![](https://i-blog.csdnimg.cn/blog_migrate/9e0b10137291702a995c95e953c4f6d6.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/d46addee8a22dd77572db5bf3a9b188e.png)

如果继续提交两次。

![](https://i-blog.csdnimg.cn/blog_migrate/9067290c1e1234131607415099c454ed.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/4e22652246a4013754647201e73cd84c.png)

事实证明，我们完成地也不错，我们将图示的三个显示屏用来展示密码

![](https://i-blog.csdnimg.cn/blog_migrate/be239bf7834681cc5edf26a39169664f.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/bce805ec81763b52b8bd1b81e881b24a.png)

最后，我们舍弃了之前做过的工作，选择模式5，完成了较为完善的引脚配置和其他功能的结合。

![](https://i-blog.csdnimg.cn/blog_migrate/7163f37695ad49584165e6220c75ad84.png)
