---
title: "XJTUCS-Internet-原始Socket模拟TCP实验"
date: 2026-06-22
tags:
- Internet原理与技术
- TCP
...
# XJTUCS-Internet-原始Socket模拟TCP实验
...
![Raw TCP State Machine](./XJTUCS-Internet-原始Socket模拟TCP实验.assets/state_machine.svg)

图 3-2 握手 + 下载 + 关闭流程图：
![Raw TCP Flow](./XJTUCS-Internet-原始Socket模拟TCP实验.assets/flow.svg)

图 3-3 数据发送/ACK/SACK 细节子流程图：
![Data Flow](./XJTUCS-Internet-原始Socket模拟TCP实验.assets/data_flow.svg)
