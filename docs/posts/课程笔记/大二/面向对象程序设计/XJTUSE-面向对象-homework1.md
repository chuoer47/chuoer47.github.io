...
![](./XJTUSE-面向对象-homework1.assets/image-001-74f93d9539.png)

判断输入格式是否正确

![](./XJTUSE-面向对象-homework1.assets/image-002-a6a194bfc9.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-003-8fe3e74591.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-004-0ec347ba43.png)

1.

这是处理三字符时候的代码，主要是分类讨论。以20，100和长度2为讨论要素开展。

![](./XJTUSE-面向对象-homework1.assets/image-005-cdb54bc7a6.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-006-6da0738b6f.png)

![](./XJTUSE-面向对象-homework1.assets/image-007-2de5598da0.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-008-1fe1956515.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-009-2a55be0fd8.png)

![](./XJTUSE-面向对象-homework1.assets/image-010-893f999019.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-011-7310c10c75.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-012-0913bc8961.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-013-a294589c59.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-014-d6c31b3d53.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-015-f1ec59140b.png)

1.

不断录入数据并且调用histogram.countAdd()方法，直到没有数据为止

![](./XJTUSE-面向对象-homework1.assets/image-016-9f3f919e66.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-017-5fb549084f.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-018-c7bd63adcb.png)
...
![](./XJTUSE-面向对象-homework1.assets/image-019-4038862687.png)

While循环使得投掷次数达到10000次。x,y通过随机数的线性四则运算得出，不失随机性。两个if语句判断是否命中奇数区域。

运行结果：

![](./XJTUSE-面向对象-homework1.assets/image-020-431beec8f4.png)
