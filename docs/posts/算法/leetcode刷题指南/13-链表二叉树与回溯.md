...
> 原文链接：<https://leetcode.cn/circle/discuss/K0n2gO/>

---

![链表题单 二叉树题单 链表题目 二叉树题目 回溯题单 回溯题目 灵茶山艾府 灵神 灵神题单](./pics/K0n2gO/meme-tree-11.jpg)
...
![DFS BFS](./pics/K0n2gO/dfsbfsnew-c.png)
...
更多树形 DP，见 [动态规划题单](./08-动态规划) 中的「树形 DP」。
...
另见 [动态规划题单](./08-动态规划) 中的「**树形 DP**」，包含换根 DP。
