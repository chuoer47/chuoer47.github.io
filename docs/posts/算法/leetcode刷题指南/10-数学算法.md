...
> 原文链接：<https://leetcode.cn/circle/discuss/IYT3ss/>

---

![数学题单 数学题目 力扣数学题单 leetcode数学 数论 组合 博弈 几何 随机 灵茶山艾府 灵神 灵神题单](./pics/IYT3ss/meme-math-bf-math.png)
...
部分题目（尤其是组合数学）会涉及到取模，我写了一篇详细的取模教程，请看 [模运算的世界：当加减乘除遇上取模](./11-模运算的世界)。
...
- [3918. 数与其逆序数之间的质数和](https://leetcode.cn/problems/sum-of-primes-between-number-and-its-reverse/) 1301
- [762. 二进制表示中质数个计算置位](https://leetcode.cn/problems/prime-number-of-set-bits-in-binary-representation/) 1383
- [3896. 将数组转换为交替质数数组的最少操作次数](https://leetcode.cn/problems/minimum-operations-to-transform-array-into-alternating-prime/) 1435
...
**模板二**：预处理 $x$ 的最小质因子 $\text{LPF}(x)$，从而做到 $\mathcal{O}(\log x)$ 分解 $x$，求出 $x$ 的质因子及其出现次数。
...
- [3927. 可整除替换后的数组最小元素和](https://leetcode.cn/problems/minimize-array-sum-using-divisible-replacements/) 1652
...
- [3574. 最大子数组 GCD 分数](https://leetcode.cn/problems/maximize-subarray-gcd-score/) 2300
...
- [3901. 好子序列查询](https://leetcode.cn/problems/good-subsequence-queries/) 2545 证明
...
- [3953. 互质元素的最大得分](https://leetcode.cn/problems/maximum-score-with-co-prime-element/) 2390
- [3336. 最大公约数相等的子序列数量](https://leetcode.cn/problems/find-the-number-of-subsequences-with-equal-gcd/) 更快的做法
...
预处理阶乘及其逆元后，可以 $\mathcal{O}(1)$ 计算组合数，模板代码如下。原理见 [模运算的世界：当加减乘除遇上取模](./11-模运算的世界)。
...
- [3881. 恰好看到 K 个人的方向选择](https://leetcode.cn/problems/direction-assignments-with-exactly-k-visible-people/) 1761
...
- [3906. 统计网格路径中好整数的数目](https://leetcode.cn/problems/count-good-integers-on-a-grid-path/) 类似 3519 题
...
- [1916. 统计为蚁群构筑房间的不同顺序](https://leetcode.cn/problems/count-ways-to-build-rooms-in-an-ant-colony/) 2486 拓扑序方案数
...
关于计数 DP 的题目，见 [动态规划题单](./08-动态规划) 的「**§7.7 计数 DP**」。
...
- [3953. 互质元素的最大得分](https://leetcode.cn/problems/maximum-score-with-co-prime-element/) 2390 莫比乌斯函数
...
另见 [动态规划题单](./08-动态规划) 的「**§11.7 斜率优化 DP**」。

### §5.5 其他

- [3899. 三角形的内角度数](https://leetcode.cn/problems/angles-of-a-triangle/) 1407
...
- [3916. 锯齿形数组的总数 III](https://leetcode.cn/problems/number-of-zigzag-arrays-iii/)（会员题）
...
- [1680. 连接连续二进制数字](https://leetcode.cn/problems/concatenation-of-consecutive-binary-numbers/) 做到 $\mathcal{O}(\log^2 n)$
