...
> 原文链接：<https://leetcode.cn/circle/discuss/01LUak/>
...
- [3991. 使用前缀反转对数组进行排序](https://leetcode.cn/problems/sort-array-using-prefix-reversals/)（会员题）
...
注：关于**网格图**的 DFS 和 BFS，请看 [网格图题单](./04-网格图)。

## 二、拓扑排序

![图论题单 图论算法 图论题目 LeetCode 力扣图论 灵茶山艾府 灵神 灵神题单](./pics/01LUak/006-toposort.png)
...
- [3924. 有限重边的最小阈值路径](https://leetcode.cn/problems/minimum-threshold-path-with-limited-heavy-edges/) 2080 也可以 0-1 BFS
...
- [3928. 购买苹果的最低成本 II](https://leetcode.cn/problems/minimum-cost-to-buy-apples-ii/) 2187
...
- [3970. 最多 K 个连续相同字符的最短路径](https://leetcode.cn/problems/shortest-path-with-at-most-k-consecutive-identical-characters/) 1840
...
Kruskal 算法模板（用到了并查集，完整模板见 [数据结构题单](./09-常用数据结构)）：
...
- [4004. 使循环数组余额非负的最少移动次数 II](https://leetcode.cn/problems/minimum-moves-to-balance-circular-array-ii/)（会员题）
...
见 [链表、树、回溯](./13-链表二叉树与回溯) 题单的第三章节。

## 关联题单

- 关于**网格图**的 DFS 和 BFS，见 [网格图题单](./04-网格图)。
