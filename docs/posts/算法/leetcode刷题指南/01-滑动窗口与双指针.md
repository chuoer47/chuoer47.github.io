...
> 原文链接：<https://leetcode.cn/circle/discuss/0viNMK/>

---

![滑动窗口题单 双指针题单 力扣题目 灵茶山艾府 灵神 灵神题单](./pics/0viNMK/lc1456.png)
...
- **滑动窗口相关**：
   - [数据结构题单](./09-常用数据结构) 中的「**单调队列**」。
   - [位运算题单](./05-位运算) 中的「**LogTrick**」。部分题目可以用滑动窗口+栈解决。
- **双指针相关**：
   - [贪心题单](./12-贪心算法) 中的「**单序列配对**」和「**双序列配对**」。
