...
> 原文链接：<https://leetcode.cn/circle/discuss/SJFwQI/>

---

![字符串题单 字符串算法 灵茶山艾府 灵神 灵神题单](./pics/SJFwQI/Knuth-Morris-Pratt.png)
...
- [3985. 回文子数组求和](https://leetcode.cn/problems/palindromic-subarray-sum/) 2202
...
- [1967. 作为子字符串出现在单词中的字符串数目](https://leetcode.cn/problems/number-of-strings-that-appear-as-substrings-in-word/) **模板题**
...
- [数据结构题单](./09-常用数据结构) 中的「**六、字典树（trie）**」。
- [滑动窗口与双指针题单](./01-滑动窗口与双指针) 中的「**§4.2 判断子序列**」。
- [数学题单](./10-数学算法) 中的「**§7.5 多项式**」。
- [贪心题单](./12-贪心算法) 中的「**三、字符串贪心**」。
