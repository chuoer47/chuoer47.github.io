...
> 原文链接：<https://leetcode.cn/circle/discuss/dHn9Vk/>

---

![位运算题单 位运算题目 位运算基础 灵茶山艾府 灵神 灵神题单](./pics/dHn9Vk/and-005.png)
...
另见 [数据结构题单](./09-常用数据结构) 中的「**§6.4 0-1 字典树（异或字典树）**」。
...
- [3858. 按位或的最小值](https://leetcode.cn/problems/minimum-bitwise-or-from-grid/) 1947
...
- [1415. 长度为 n 的开心字符串中字典序第 k 小的字符串](https://leetcode.cn/problems/the-k-th-lexicographical-string-of-all-happy-strings-of-length-n/) 做到 $\mathcal{O}(n)$ 时间
- [1261. 在受污染的二叉树中查找元素](https://leetcode.cn/problems/find-elements-in-a-contaminated-binary-tree/) 做到 $\mathcal{O}(1)$ 额外空间
- [1545. 找出第 N 个二进制字符串中的第 K 位](https://leetcode.cn/problems/find-kth-bit-in-nth-binary-string/) 做到 $\mathcal{O}(1)$ 时间
- [89. 格雷编码](https://leetcode.cn/problems/gray-code/)
- [1238. 循环码排列](https://leetcode.cn/problems/circular-permutation-in-binary-representation/) 1775
- [2126. 摧毁小行星](https://leetcode.cn/problems/destroying-asteroids/) 做到 $\mathcal{O}(n)$
...
1. [数据结构题单](./09-常用数据结构) 中的「**§6.4 0-1 字典树（异或字典树）**」。
2. [链表、二叉树与回溯](./13-链表二叉树与回溯) 中的部分回溯题目，可以用**二进制搜索**解决。
...
6. [图论算法（DFS/BFS/拓扑排序/基环树/最短路/最小生成树/网络流）](./07-图论算法)
7. [动态规划（入门/背包/划分/状态机/区间/状压/数位/数据结构优化/树形/博弈/概率期望）](./08-动态规划)
...
11. [链表、树与回溯（前后指针/快慢指针/DFS/BFS/直径/LCA）](./13-链表二叉树与回溯)
