...
> 原文链接：<https://leetcode.cn/circle/discuss/g6KTKL/>

---

![贪心题单 贪心题目 力扣贪心题单 leetcode贪心 greedy 灵茶山艾府 灵神 灵神题单](./pics/g6KTKL/greedy-vs-dp-c.jpg)
...
- [3947. 购买最多物品数目 II](https://leetcode.cn/problems/maximum-number-of-items-from-sale-ii/) 2215
...
读者可以对比下面的题目和 [动态规划题单](./08-动态规划) 中的线性 DP、状态机 DP 的区别，思考什么情况下只能 DP 不能贪心，从而加深对「局部最优」和「全局最优」的理解。
...
- [3980. 变换二进制字符串的最少操作次数](https://leetcode.cn/problems/minimum-operations-to-transform-binary-string/) 1846
...
读者可以对比下面的题目和 [动态规划题单](./08-动态规划) 中的划分型 DP 的区别，思考什么情况下只能 DP 不能贪心，从而加深对「局部最优」和「全局最优」的理解。
...
- [3897. 连接二进制片段得到的最大值](https://leetcode.cn/problems/maximum-value-of-concatenated-binary-segments/) 1998
...
**变形**：每个区间有各自的分数，从中选一些两两互不相交的区间，最大化得分之和。详见 [动态规划题单](./08-动态规划) 的「**§7.2 不相交区间**」。
...
- [3951. 维持亮度的最小总能量](https://leetcode.cn/problems/minimum-energy-to-maintain-brightness/) 1530
- [3975. 筛选忙碌区间](https://leetcode.cn/problems/filter-occupied-intervals/) 1533
- [3964. 照亮道路的最少灯泡数](https://leetcode.cn/problems/minimum-lights-to-illuminate-a-road/) 1572
...
- [4000. 给定数位和的最大整数](https://leetcode.cn/problems/largest-integer-with-given-digit-sum/) 1200
...
另见 [数学题单](./10-数学算法) 的「**§7.1 回文数**」。

### §3.3 合法括号字符串

见 [数据结构题单](./09-常用数据结构) 中的「**§3.4 合法括号字符串**」。
...
- [4014. 应用折扣后的最低总价](https://leetcode.cn/problems/minimum-total-price-after-applying-discounts/) 1192
- [3974. K 个元素的最大总和](https://leetcode.cn/problems/maximum-total-sum-of-k-selected-elements/) 1263
...
- [3996. 偶数次骑士移动](https://leetcode.cn/problems/even-number-of-knight-moves/) 1260
...
- [3987. 处理所有元素的成本](https://leetcode.cn/problems/minimum-total-cost-to-process-all-elements/) 1550
...
- [3961. 设备评分的最大和](https://leetcode.cn/problems/maximize-sum-of-device-ratings/) 1880
...
- [2202. K 次操作后最大化顶端元素](https://leetcode.cn/problems/maximize-the-topmost-element-after-k-moves/) 1717
- [3922. 使二进制字符串连贯的最少翻转次数](https://leetcode.cn/problems/minimum-flips-to-make-binary-string-coherent/) 1759
...
- [3942. 排序排列的最少操作数](https://leetcode.cn/problems/minimum-operations-to-sort-a-permutation/) 1855
...
- [3963. 构造恰好一条路径的网格](https://leetcode.cn/problems/create-grid-with-exactly-one-path/) 1311
...
- [3988. 创建一个恰好有 K 条路径的网格图 I](https://leetcode.cn/problems/create-grid-with-exactly-k-paths-i/) 2055
...
- [3990. 创建一个恰好有 K 条路径的网格图 II](https://leetcode.cn/problems/create-grid-with-exactly-k-paths-ii/)（会员题）
...
- [2833. 距离原点最远的点](https://leetcode.cn/problems/furthest-point-from-origin/) 1294
...
此外，这也说明按照题单刷题的缺点：提前知道题目类型，跳过了一些思考步骤。如何弥补这个缺点？请看 [如何科学刷题](./00-如何科学刷题)。

## 关联题单

- [数学题单](./10-数学算法) 中的「博弈论」。
- [数据结构题单](./09-常用数据结构) 中的「堆」。
- [图论题单](./07-图论算法) 中的 Dijkstra 算法和 Kruskal/Prim 算法，这些算法都是基于贪心策略一的，即优先选最小的数。
