...
这样子的数字以 1 为间隔或者三位数间隔是根本不可能在考试中遍历出来。

所以开始查阅资料，发现准确解法为中国剩余定理。

参考博客：[中国剩余定理学习笔记](https://www.cnblogs.com/MashiroSky/p/5918158.html)
