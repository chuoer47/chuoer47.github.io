<template><div><!--more--->
<h1 id="docker" tabindex="-1"><a class="header-anchor" href="#docker"><span>Docker</span></a></h1>
<h2 id="一、dcoker介绍" tabindex="-1"><a class="header-anchor" href="#一、dcoker介绍"><span>一、Dcoker介绍</span></a></h2>
...
<figure><img src="/image\docker4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container info">
<p class="hint-container-title">Docker主要用于几下几个方面</p>
<ol>
<li>提供一次性的环境。</li>
...
<h2 id="二、docker安装" tabindex="-1"><a class="header-anchor" href="#二、docker安装"><span>二、Docker安装</span></a></h2>
<h3 id="_1、卸载老版本" tabindex="-1"><a class="header-anchor" href="#_1、卸载老版本"><span>1、卸载老版本</span></a></h3>
<p>ubuntu下自带了docker的库，不需要添加新的源。但是ubuntu自带的docker版本太低，需要先卸载旧的再安装新的。</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">apt-get</span> remove <span class="token function">docker</span> docker-engine docker.io containerd runc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2、更新软件包" tabindex="-1"><a class="header-anchor" href="#_2、更新软件包"><span>2、更新软件包</span></a></h3>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> update
<span class="token function">sudo</span> <span class="token function">apt</span> upgrade
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、安装docker依赖" tabindex="-1"><a class="header-anchor" href="#_3、安装docker依赖"><span>3、安装docker依赖</span></a></h3>
<p>安装工具：</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">apt-get</span> <span class="token parameter variable">-y</span> <span class="token function">install</span> apt-transport-https ca-certificates <span class="token function">curl</span> software-properties-common
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">apt-get</span> <span class="token function">install</span> ca-certificates <span class="token function">curl</span> gnupg lsb-release
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4、添加docker官方gpg密钥" tabindex="-1"><a class="header-anchor" href="#_4、添加docker官方gpg密钥"><span>4、添加Docker官方GPG密钥</span></a></h3>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-fsSL</span> http://mirrors.aliyun.com/docker-ce/linux/ubuntu/gpg <span class="token operator">|</span> <span class="token function">sudo</span> apt-key <span class="token function">add</span> -
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_5、添加docker软件源" tabindex="-1"><a class="header-anchor" href="#_5、添加docker软件源"><span>5、添加docker软件源</span></a></h3>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> add-apt-repository <span class="token string">"deb [arch=amd64] http://mirrors.aliyun.com/docker-ce/linux/ubuntu <span class="token variable"><span class="token variable">$(</span>lsb_release <span class="token parameter variable">-cs</span><span class="token variable">)</span></span> stable"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_6、安装docker" tabindex="-1"><a class="header-anchor" href="#_6、安装docker"><span>6、安装docker</span></a></h3>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">apt-get</span> <span class="token function">install</span> docker-ce docker-ce-cli containerd.io
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_7、配置用户组-可选" tabindex="-1"><a class="header-anchor" href="#_7、配置用户组-可选"><span>7、配置用户组（可选）</span></a></h3>
<p>默认情况下，只有root用户和docker组的用户才能运行Docker命令。我们可以将当前用户添加到docker组，以避免每次使用Docker时都需要使用sudo</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">usermod</span> <span class="token parameter variable">-aG</span> <span class="token function">docker</span> <span class="token environment constant">$USER</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>注意：重新登录才能使更改生效。</p>
<h3 id="_8、启动" tabindex="-1"><a class="header-anchor" href="#_8、启动"><span>8、启动</span></a></h3>
<div class="hint-container info">
<p class="hint-container-title">运行docker</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">docker</span> version
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查看镜像:</p>
<p>上面我们拉取了hello-world的镜像，现在我们可以通过命令来查看镜像，命令如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">docker</span> images
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_9、配置镜像加速" tabindex="-1"><a class="header-anchor" href="#_9、配置镜像加速"><span>9、配置镜像加速</span></a></h3>
<p>打开阿里云-&gt;产品-&gt;容器-&gt;容器镜像服务ACR-&gt;镜像工具下的配置镜像加速</p>
<h2 id="三、docker基础" tabindex="-1"><a class="header-anchor" href="#三、docker基础"><span>三、docker基础</span></a></h2>
<h3 id="_1、快速入门" tabindex="-1"><a class="header-anchor" href="#_1、快速入门"><span>1、快速入门</span></a></h3>
<p>docker安装mysql</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>解释：</strong></p>
<ul>
<li><code v-pre>docker run</code>: 创建并运行一个容器， <code v-pre>-d</code>是让容器在后台运行</li>
<li><code v-pre>--name mysql</code>:给容器起名字，必须唯一</li>
<li><code v-pre>-p 3306:3306</code>设置端口映射     -&gt; 将宿主机器的3306端口和容器内3306端口进行映射</li>
<li><code v-pre>-e KEY=VALUE</code>:环境变量设置</li>
<li><code v-pre>mysql</code>：指定运行的镜像的名字
<ul>
<li>镜像名称：[repository]:[tag]
<ul>
<li>repository:镜像名</li>
<li>tag:镜像的版本</li>
</ul>
</li>
<li>没有指定tag时，默认是latest，代表最新版本的镜像</li>
</ul>
</li>
</ul>
<h3 id="_2、常见命令" tabindex="-1"><a class="header-anchor" href="#_2、常见命令"><span>2、常见命令</span></a></h3>
<figure><img src="/image\docker1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="_1-容器操作" tabindex="-1"><a class="header-anchor" href="#_1-容器操作"><span>1）容器操作</span></a></h4>
<p>docker container基本命令</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 创建docker容器</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 关闭多个容器（笨方法）</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 端口映射         服务器端口:容器端口</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 查看日志</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-镜像操作" tabindex="-1"><a class="header-anchor" href="#_2-镜像操作"><span>2）镜像操作</span></a></h4>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 拉取镜像,不同版本有区别,后面可以加版本号</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment">#导出镜像,先进入要导出到的目录</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、数据卷" tabindex="-1"><a class="header-anchor" href="#_3、数据卷"><span>3、数据卷</span></a></h3>
<p>数据卷（volume）是一个虚拟目录，是容器内目录与宿主机目录之间映射的桥梁</p>
<figure><img src="/image\docker2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>数据卷命令</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> volume create <span class="token comment">#创建数据卷</span>
...
<ul>
<li>只有在容器创建的时候才可以挂载，使用<code v-pre>-v 数据卷:容器内目录</code></li>
<li>当创建容器时，如果挂载了数据卷且数据卷不存在，会自动创建数据卷</li>
</ul>
</div>
<div class="hint-container tip">
<p class="hint-container-title">本地目录与容器内目录的挂载</p>
<ul>
<li>在执行<code v-pre>docker run</code>命令时，使用 <code v-pre>-v 本地目录:容器内目录</code> 可以完成本地目录挂载</li>
<li>本地目录必须以“/”或&quot;./”开头，如果直接以名称开头，会被识别为数据卷而非本地目录
<ul>
<li><code v-pre>-v mysql:/var/lib/mysq</code>l 会被识别为一个数据卷叫mysql</li>
<li><code v-pre>-v ./mysql:/var/lib/mysql</code> 会被识别为当前目录下的mysql目录</li>
</ul>
</li>
</ul>
</div>
<h3 id="_4、自定义镜像" tabindex="-1"><a class="header-anchor" href="#_4、自定义镜像"><span>4、自定义镜像</span></a></h3>
<p>镜像就是包含了应用程序、程序运行的系统函数库、运行配置等文件的文件包。构建镜像的过程其实就是把上述文件打包的过程。</p>
<h4 id="_1-dockerfile常见指令" tabindex="-1"><a class="header-anchor" href="#_1-dockerfile常见指令"><span>1）Dockerfile常见指令</span></a></h4>
<table>
<thead>
<tr>
<th>指令</th>
...
<td>COPY  ./jrell.tar.gz  /tmp</td>
</tr>
<tr>
<td>RUN</td>
<td>执行Linux的shell命令，一般是安装过程的命令</td>
<td>RUN  tar  -zxvf  /tmp/jrell.tar.gz  &amp;&amp; EXPORTS  path=/tmp/jrell:$path</td>
</tr>
<tr>
<td>EXPOSE</td>
<td>指定容器运行时监听的端口，给镜像使用者看的</td>
<td>EXPOSE  8080</td>
</tr>
<tr>
<td>ENTRYPOINT</td>
...
<p>更多详细说明，请参看官网文档：<a href="https://docs.docker.com/engine/reference/builder" target="_blank" rel="noopener noreferrer">https://docs.docker.com/engine/reference/builder</a></p>
<h4 id="_2-利用dockerfile构建镜像" tabindex="-1"><a class="header-anchor" href="#_2-利用dockerfile构建镜像"><span>2）利用Dockerfile构建镜像</span></a></h4>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 从Dockerfile构建镜像</span>
...
<ul>
<li><code v-pre>-t</code>是给镜像起名，格式依然是repository:tag的格式，不指定tag时默认为latest</li>
<li><code v-pre>.</code>指定Dockerfile所在目录，如果就在当前目录，则指定为&quot;.&quot;</li>
</ul>
</div>
<p>镜像上传：</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 修改镜像名字,上传到dockerhub上要遵守命名规范</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-示例" tabindex="-1"><a class="header-anchor" href="#_3-示例"><span>3）示例</span></a></h4>
<p>基于docker部署web应用：</p>
<p>Dockerfile:</p>
<div class="language-docker line-numbers-mode" data-ext="docker" data-title="docker"><pre v-pre class="language-docker"><code><span class="token comment"># 基础镜像</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后运行该镜像</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 创建并运行容器</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、容器网络互联" tabindex="-1"><a class="header-anchor" href="#_5、容器网络互联"><span>5、容器网络互联</span></a></h3>
...
<p>示例：</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 1.首先通过命令创建一个网络</span>
...
<h3 id="_6、dockercompose" tabindex="-1"><a class="header-anchor" href="#_6、dockercompose"><span>6、DockerCompose</span></a></h3>
<p>Docker Compose通过一个单独的docker-compose.ymL模板文件(YAML格式)来定义一组相关联的应用容器，帮助我们实现<strong>多个相互关联的Docker容器的快速部署。</strong></p>
<figure><img src="/image\docker3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>示例：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>docker compose 命令格式：</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> compose <span class="token punctuation">[</span>OPTIONS<span class="token punctuation">]</span> <span class="token punctuation">[</span>COMMAND<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>
<p><code v-pre>Options</code></p>
<ul>
<li><code v-pre>-f</code>指定compose文件的路径和名称</li>
<li><code v-pre>-p</code>指定project名称</li>
</ul>
</li>
<li>
<p><code v-pre>Commands</code></p>
<ul>
<li><code v-pre>up</code> 创建并启动所有service容器</li>
<li><code v-pre>down</code>停止并移除所有容器，网络</li>
<li><code v-pre>ps</code>列出所有启动的容器</li>
<li><code v-pre>logs</code>查看指定容器的日志</li>
...
<li><code v-pre>exec</code>在指定的运行中容器中执行命令</li>
</ul>
</li>
</ul>
<p><strong>示例：</strong> 使用DockerCompose部署minio</p>
<p>docker-compose.yml文件</p>
<div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">'3'</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> compose up <span class="token parameter variable">-d</span>  <span class="token comment">#-d是后台启动</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>其他命令：</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 查看镜像</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四、案例" tabindex="-1"><a class="header-anchor" href="#四、案例"><span>四、案例</span></a></h2>
<h3 id="_1、部署mysql" tabindex="-1"><a class="header-anchor" href="#_1、部署mysql"><span>1、部署mysql</span></a></h3>
<p>首先启动一个mysql并复制配置文件到宿主机器</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> <span class="token function">cp</span> mysql:/var/lib/mysql /root/mysql/data
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>之后删除之前的容器，并重新按以下命令启动</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\</span>
  <span class="token parameter variable">--name</span> mysql <span class="token punctuation">\</span>
  <span class="token parameter variable">-p</span> <span class="token number">3306</span>:3306 <span class="token punctuation">\</span>
  <span class="token parameter variable">-e</span> <span class="token assign-left variable">TZ</span><span class="token operator">=</span>Asia/Shanghai <span class="token punctuation">\</span>
  ...
  mysql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、nginx" tabindex="-1"><a class="header-anchor" href="#_2、nginx"><span>2、nginx</span></a></h3>
<p>拷贝要挂载的文件</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> <span class="token function">cp</span> nginx:/etc/nginx /root/nginx_blog/conf
...
nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、seata" tabindex="-1"><a class="header-anchor" href="#_3、seata"><span>3、seata</span></a></h3>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>docker run --name seata \
-p 8099:8099 \
-p 7099:7099 \
-e SEATA_IP=ipaddr \
...
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>docker run -d \
--name nacos \
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、sentinel" tabindex="-1"><a class="header-anchor" href="#_5、sentinel"><span>5、sentinel</span></a></h3>
<p>dockerfile:</p>
<div class="language-docker line-numbers-mode" data-ext="docker" data-title="docker"><pre v-pre class="language-docker"><code><span class="token comment"># 基础镜像</span>
<span class="token instruction"><span class="token keyword">FROM</span> openjdk:11.0-jre-buster</span>
<span class="token comment"># 设定时区</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6、xxl-job" tabindex="-1"><a class="header-anchor" href="#_6、xxl-job"><span>6、xxl-job</span></a></h3>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code> <span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\</span>
