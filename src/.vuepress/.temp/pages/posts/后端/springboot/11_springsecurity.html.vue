<template><div><!--more--->
<h1 id="springsecurity" tabindex="-1"><a class="header-anchor" href="#springsecurity"><span>SpringSecurity</span></a></h1>
<h2 id="一、介绍" tabindex="-1"><a class="header-anchor" href="#一、介绍"><span>一、介绍</span></a></h2>
<h3 id="_1、springsecurity" tabindex="-1"><a class="header-anchor" href="#_1、springsecurity"><span>1、SpringSecurity</span></a></h3>
...
<p>Spring Security是Spring项目组提供的安全服务框架，核心功能包 括认证和授权。它为系统提供了声明式安全访问控制功能，减少了 为系统安全而编写大量重复代码的工作。</p>
<ul>
<li>
<p><a href="https://spring.io/projects/spring-security" target="_blank" rel="noopener noreferrer">项目主页</a></p>
</li>
<li>
<p><a href="https://spring.io/projects/spring-cloud-security" target="_blank" rel="noopener noreferrer">Spring cloud Security</a></p>
</li>
</ul>
...
<p>认证即系统判断用户的身份是否合法，合法可继续访问，不合法则拒绝访问。</p>
<p>常见的用户身份认证方式有：用户名密码登录、二维码登录、手机短信登录、脸部识别认证、指纹认证等方式。 认证是为了保护系统的隐私数据与资源，用户的身份合法才能访问 该系统的资源。</p>
<ul>
<li><strong>授权</strong></li>
</ul>
<p>授权即<strong>认证通过后</strong>，根据用户的权限来控制用户访问资源的过程， 拥有资源的访问权限则正常访问，没有权限则拒绝访问。 比如在一 些视频网站中，普通用户登录后只有观看免费视频的权限，而VIP用户登录后，网站会给该用户提供观看VIP视频的权限。</p>
<p><strong>认证是为了保证用户身份的合法性，授权则是为了更细粒度的对隐私数据进行划分，控制不同的用户能够访问不同的资源。</strong></p>
<p>举个例子：认证是公司大门识别你作为员工能进入公司，而授权则 是由于你作为公司会计可以进入财务室，查看账目，处理财务数据。</p>
</div>
<h3 id="_2、oauth2" tabindex="-1"><a class="header-anchor" href="#_2、oauth2"><span>2、OAuth2</span></a></h3>
<p>像微信扫码认证这种第三方认证的方式一般都是基于OAuth2协议实现，OAUTH协议为用户资源的授权提供了一个安全的、开放而又简易的标准。同时，任何第三方都可以使用OAUTH认证服务，任何服务提供商都可以实现自身的OAUTH认证服务，因而OAUTH是开放的。</p>
<p>业界提供了OAUTH的多种实现如PHP、JavaScript，Java，Ruby等各种语言开发包，大大节约了程序员的时间，因而OAUTH是简易的。互联网很多服务如Open API，很多大公司如Google，Yahoo，Microsoft等都提供了OAUTH认证服务，这些都足以说明OAUTH标准逐渐成为开放资源授权的标准。</p>
<p>Oauth协议目前发展到2.0版本，1.0版本过于复杂，2.0版本已得到广泛应用。</p>
<ul>
<li>
<p><a href="https://baike.baidu.com/item/oAuth/7153134?fr=aladdin" target="_blank" rel="noopener noreferrer">参考</a></p>
</li>
<li>
<p><a href="https://tools.ietf.org/html/rfc6749" target="_blank" rel="noopener noreferrer">Oauth协议</a></p>
</li>
</ul>
<p>Oauth2.0的认证流程，如下：</p>
<figure><img src="/image/spring/spring3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>Oauth2包括以下角色：</p>
<ul>
<li>
<p>1、客户端</p>
<ul>
<li>本身不存储资源，需要通过资源拥有者的授权去请求资源服务器的资源，比如：手机客户端、浏览器等。</li>
</ul>
</li>
<li>
<p>2、资源拥有者</p>
...
<h2 id="二、快速入门" tabindex="-1"><a class="header-anchor" href="#二、快速入门"><span>二、快速入门</span></a></h2>
<h3 id="_1、引入依赖" tabindex="-1"><a class="header-anchor" href="#_1、引入依赖"><span>1、引入依赖</span></a></h3>
<p>向pom.xml加入Spring Security所需要的依赖</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、进行安全配置" tabindex="-1"><a class="header-anchor" href="#_2、进行安全配置"><span>2、进行安全配置</span></a></h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>主要配置三部分内容：</p>
<p>1、用户信息</p>
<p>在内存配置两个用户：zhangsan、lisi。zhangsan用户拥有的权限为p1，lisi用户拥有的权限为p2</p>
<p>2、密码方式</p>
<p>暂时采用明文方式</p>
<p>3、安全拦截机制</p>
<p>/r/**开头的请求需要认证，登录成功到成功页面</p>
<h3 id="_3、测试" tabindex="-1"><a class="header-anchor" href="#_3、测试"><span>3、测试</span></a></h3>
<p>之后可以编写介个接口分别进行测试,下边在controller中配置/r/r1需要p1权限，/r/r2需要p2权限。</p>
<p><code v-pre>hasAuthority('p1')</code>表示拥有p1权限方可访问。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、工作原理" tabindex="-1"><a class="header-anchor" href="#三、工作原理"><span>三、工作原理</span></a></h2>
<p>通过测试认证和授权两个功能，我们了解了Spring Security的基本使用方法，下边了解它的工作流程。</p>
<p>Spring Security所解决的问题就是<strong>安全访问控制</strong>，而安全访问控制功能其实就是对所有进入系统的请求进行拦截，校验每个请求是否能够访问它所期望的资源。根据前边知识的学习，可以通过Filter或AOP等技术来实现，<strong>Spring Security对Web资源的保护是靠Filter实现的</strong>，所以从这个Filter来入手，逐步深入Spring Security原理。</p>
<p>​        当初始化Spring Security时，会创建一个名为<code v-pre>SpringSecurityFilterChain</code>的Servlet过滤器，类型为<code v-pre>org.springframework.security.web.FilterChainProxy</code>，它实现了<code v-pre>javax.servlet.Filter</code>，因此外部的请求会经过此类，下图是Spring Security过虑器链结构图：</p>
<figure><img src="/image/spring/spring4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><code v-pre>FilterChainProxy</code>是一个代理，真正起作用的是<code v-pre>FilterChainProxy中SecurityFilterChain</code>所包含的各个Filter，同时这些Filter作为Bean被Spring管理，它们是Spring Security核心，各有各的职责，但他们并不直接处理用户的<strong>认证</strong>，也不直接处理用户的<strong>授权</strong>，而是把它们交给了 <strong>认证管理器（<code v-pre>AuthenticationManager</code>）和决策管理器（<code v-pre>AccessDecisionManager</code>）</strong> 进行处理。</p>
<p>spring Security功能的实现主要是由一系列过滤器链相互配合完成。</p>
<figure><img src="/image/spring/spring5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>下面介绍过滤器链中主要的几个过滤器及其作用：</p>
<ul>
<li>
<p><strong>SecurityContextPersistenceFilter</strong> 这个Filter是整个拦截过程的入口和出口（也就是第一个和最后一个拦截器），会在请求开始时从配置好的<code v-pre>SecurityContextRepository</code>中获取 <code v-pre>SecurityContext</code>，然后把它设置给<code v-pre> SecurityContextHolder</code>。在请求完成后将 <code v-pre>SecurityContextHolder</code> 持有的<code v-pre>SecurityContext</code>再保存到配置好的<code v-pre>SecurityContextRepository</code>，同时清除 <code v-pre>securityContextHolder </code>所持有的 <code v-pre>SecurityContext</code>；</p>
</li>
<li>
<p><strong>UsernamePasswordAuthenticationFilter</strong> 用于处理来自表单提交的认证。该表单必须提供对应的用户名和密码，其内部还有登录成功或失败后进行处理的 <code v-pre>AuthenticationSuccessHandler </code>和<code v-pre> AuthenticationFailureHandler</code>，这些都可以根据需求做相关改变；</p>
</li>
<li>
<p><strong>FilterSecurityInterceptor</strong> 是用于保护web资源的，使用<code v-pre>AccessDecisionManager</code>对当前用户进行授权访问，前面已经详细介绍过了；</p>
</li>
<li>
<p><strong>ExceptionTranslationFilter</strong> 能够捕获来自 FilterChain 所有的异常，并进行处理。但是它只会处理两类异常：<code v-pre>AuthenticationException </code>和 <code v-pre>AccessDeniedException</code>，其它的异常它会继续抛出。</p>
</li>
</ul>
<p>Spring Security的执行流程如下：</p>
<figure><img src="/image/spring/spring6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>
<ol>
<li>用户提交用户名、密码被<code v-pre>SecurityFilterChain</code>中的<code v-pre>UsernamePasswordAuthenticationFilter</code>过滤器获取到，封装为请求<code v-pre>Authentication</code>，通常情况下是<code v-pre>UsernamePasswordAuthenticationToken</code>这个实现类。</li>
</ol>
</li>
<li>
<ol start="2">
<li>然后过滤器将<code v-pre>Authentication</code>提交至认证管理器（<code v-pre>AuthenticationManager</code>）进行认证</li>
</ol>
</li>
<li>
<ol start="3">
<li>认证成功后，<code v-pre>AuthenticationManager</code>身份管理器返回一个被填充满了信息的（包括上面提到的权限信息，身份信息，细节信息，但密码通常会被移除）<code v-pre>Authentication</code>实例。</li>
</ol>
</li>
<li>
<ol start="4">
<li><code v-pre>SecurityContextHolder</code>安全上下文容器将第3步填充了信息的<code v-pre>Authentication</code>，通过<code v-pre>SecurityContextHolder.getContext().setAuthentication(…)</code>方法，设置到其中。</li>
</ol>
</li>
</ul>
<p>可以看出<code v-pre>AuthenticationManager</code>接口（认证管理器）是认证相关的核心接口，也是发起认证的出发点，它的实现类为<code v-pre>ProviderManager</code>。而Spring Security支持多种认证方式，因此<code v-pre>ProviderManager</code>维护着一个<code v-pre>List&lt;AuthenticationProvider&gt;</code>列表，存放多种认证方式，最终实际的认证工作是由<code v-pre>AuthenticationProvider</code>完成的。咱们知道web表单的对应的<code v-pre>AuthenticationProvider</code>实现类为<code v-pre>DaoAuthenticationProvider</code>，它的内部又维护着一个<code v-pre>UserDetailsService</code>负责<code v-pre>UserDetails</code>的获取。最终<code v-pre>AuthenticationProvider</code>将<code v-pre>UserDetails</code>填充至<code v-pre>Authentication</code>。</p>
<h2 id="四、oauth2使用" tabindex="-1"><a class="header-anchor" href="#四、oauth2使用"><span>四、OAuth2使用</span></a></h2>
<h3 id="_1、oauth2在学成在线项目中的应用" tabindex="-1"><a class="header-anchor" href="#_1、oauth2在学成在线项目中的应用"><span>1、OAuth2在学成在线项目中的应用</span></a></h3>
...
<h3 id="_2、oauth2的授权模式" tabindex="-1"><a class="header-anchor" href="#_2、oauth2的授权模式"><span>2、OAuth2的授权模式</span></a></h3>
<p>Spring Security支持OAuth2认证，OAuth2提供授权码模式、密码模式、简化模式、客户端模式等四种授权模式，前边举的微信扫码登录的例子就是基于授权码模式，这四种模式中授权码模式和密码模式应用较多。</p>
<h4 id="_1-授权码模式" tabindex="-1"><a class="header-anchor" href="#_1-授权码模式"><span>1）授权码模式</span></a></h4>
...
<p>下图是授权码模式的交互图：</p>
<figure><img src="/image/spring/spring7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<p>首先要配置授权服务器即上图中的认证服务器，需要配置授权服务及令牌策略。</p>
<p>配置AuthorizationServer:</p>
<p><strong>1）ClientDetailsServiceConfigurer</strong>：用来配置客户端详情服务（ClientDetailsService），</p>
...
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">javax<span class="token punctuation">.</span>annotation<span class="token punctuation">.</span></span><span class="token class-name">Resource</span></span><span class="token punctuation">;</span>
 ...
 <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置TokenConfig.java令牌策略配置类:</p>
...
<ul>
<li><strong>1）get请求获取授权码</strong></li>
</ul>
<p>地址:</p>
<p><code v-pre> http://localhost:63070/auth/oauth/authorize?client_id=XcWebApp&amp;response_type=code&amp;scope=all&amp;redirect_uri=http://www.51xuecheng.cn</code></p>
<p>参数列表如下：</p>
<ul>
...
<p>输入账号zhangsan、密码123登录成功，输入:</p>
<p><code v-pre>/oauth/authorize?client_id=XcWebApp&amp;response_type=code&amp;scope=all&amp;redirect_uri=http://www.51xuecheng.cn</code></p>
<p>显示授权页面:授权“XcWebApp”访问自己的受保护资源?选择同意。</p>
<ul>
<li>
<p><strong>2）请求成功</strong></p>
<p>重定向至<code v-pre>http://www.51xuecheng.cn/?code=授权码</code>，比如：<code v-pre>http://www.51xuecheng.cn/?code=Wqjb5H</code></p>
</li>
<li>
<p><strong>3）使用httpclient工具post申请令牌</strong></p>
</li>
</ul>
<p><code v-pre>/auth/oauth/token?client_id=XcWebApp&amp;client_secret=XcWebApp&amp;grant_type=authorization_code&amp;code=授权码&amp;redirect_uri=http://www.51xuecheng.cn/</code></p>
<p>参数列表如下</p>
<ul>
<li>client_id：客户端准入标识。</li>
...
<p>httpclient脚本如下：</p>
<div class="language-Plain line-numbers-mode" data-ext="Plain" data-title="Plain"><pre v-pre class="language-Plain"><code>### 授权码模式
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>申请令牌成功如下所示：</p>
...
<h4 id="_2-密码模式" tabindex="-1"><a class="header-anchor" href="#_2-密码模式"><span>2）密码模式</span></a></h4>
<p>密码模式相对授权码模式简单，授权码模式需要借助浏览器供用户亲自授权，密码模式不用借助浏览器，如下图：</p>
<figure><img src="/image/spring/spring8.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>1、资源拥有者提供账号和密码</p>
<p>2、客户端向认证服务申请令牌，请求中携带账号和密码</p>
<p>3、认证服务校验账号和密码正确颁发令牌。</p>
<p>开始测试：</p>
<p><strong>1)POST请求获取令牌</strong></p>
<p><code v-pre>/auth/oauth/token?client_id=XcWebApp&amp;client_secret=XcWebApp&amp;grant_type=password&amp;username=shangsan&amp;password=123</code></p>
<p>参数列表如下：</p>
<ul>
<li>client_id：客户端准入标识。</li>
<li>client_secret：客户端秘钥。</li>
...
<p><strong>2）授权服务器将令牌（access_token）发送给client</strong></p>
<p>使用httpclient进行测试</p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>### 密码模式
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>返回示例：</p>
<div class="language-JSON line-numbers-mode" data-ext="JSON" data-title="JSON"><pre v-pre class="language-JSON"><code>{
  &quot;access_token&quot;: &quot;368b1ee7-a9ee-4e9a-aae6-0fcab243aad2&quot;,
  &quot;token_type&quot;: &quot;bearer&quot;,
  &quot;refresh_token&quot;: &quot;3d56e139-0ee6-4ace-8cbe-1311dfaa991f&quot;,
...
<h3 id="_3、使用jwt令牌" tabindex="-1"><a class="header-anchor" href="#_3、使用jwt令牌"><span>3、使用JWT令牌</span></a></h3>
<p>在认证服务中配置jwt令牌服务，即可实现生成jwt格式的令牌,</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TokenConfig</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
			<span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>拿到了jwt令牌下一步就要携带令牌去访问资源服务中的资源，本项目各个微服务就是资源服务，比如：内容管理服务，客户端申请到jwt令牌，携带jwt去内容管理服务查询课程信息，此时内容管理服务要对jwt进行校验，只有jwt合法才可以继续访问。如下图：</p>
<figure><img src="/image/spring/spring9.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>1、在内容管理服务的content-api工程中添加依赖</p>
<div class="language-XML line-numbers-mode" data-ext="XML" data-title="XML"><pre v-pre class="language-XML"><code>&lt;!--认证相关--&gt;
&lt;dependency&gt;
...
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、配置TokenConfig和ResouceServerConfig 到内容管理的api工程的config包下。</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TokenConfig</span> <span class="token punctuation">{</span>
...
<div class="language-Plain line-numbers-mode" data-ext="Plain" data-title="Plain"><pre v-pre class="language-Plain"><code>### 查询课程信息
GET http://localhost:63040/content/course/2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>返回：</p>
<div class="language-JSON line-numbers-mode" data-ext="JSON" data-title="JSON"><pre v-pre class="language-JSON"><code>{
  &quot;error&quot;: &quot;unauthorized&quot;,
...
<div class="language-Plain line-numbers-mode" data-ext="Plain" data-title="Plain"><pre v-pre class="language-Plain"><code>### 携带token访问资源服务
GET http://localhost:63040/content/course/2
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在请求头中添加Authorization，内容为Bearer 令牌，Bearer用于通过oauth2.0协议访问资源。</p>
<p>如果携带jwt令牌且jwt正确则正常访问资源服务的内容。如果不正确则报令牌无效的错误：</p>
<div class="language-JSON line-numbers-mode" data-ext="JSON" data-title="JSON"><pre v-pre class="language-JSON"><code>{
  &quot;error&quot;: &quot;invalid_token&quot;,
  &quot;error_description&quot;: &quot;Cannot convert access token to JSON&quot;
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、获取用户身份" tabindex="-1"><a class="header-anchor" href="#_4、获取用户身份"><span>4、获取用户身份</span></a></h3>
...
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>@ApiOperation(&quot;根据课程id查询课程基础信息&quot;)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="参考" tabindex="-1"><a class="header-anchor" href="#参考"><span>参考</span></a></h1>
<p>[1] <a href="https://juejin.cn/post/7194815689541025853" target="_blank" rel="noopener noreferrer">https://juejin.cn/post/7194815689541025853</a></p>
</div></template>
