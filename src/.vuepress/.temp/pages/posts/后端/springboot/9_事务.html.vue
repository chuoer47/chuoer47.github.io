<template><div><!--more--->
<h1 id="spring事务" tabindex="-1"><a class="header-anchor" href="#spring事务"><span>Spring事务</span></a></h1>
<h2 id="一、概念" tabindex="-1"><a class="header-anchor" href="#一、概念"><span>一、概念</span></a></h2>
...
<p>事务能否生效数据库引擎是否支持事务是关键。比如常用的 MySQL 数据库默认使用支持事务的 <code v-pre>innodb</code>引擎。但是，如果把数据库引擎变为 <code v-pre>myisam</code>，那么程序也就不再支持事务了！</p>
</div>
<div class="hint-container tip">
<p class="hint-container-title">事务的特性（ACID）</p>
<ul>
<li>
<p><strong>原子性</strong>（<code v-pre>Atomicity</code>）：事务是最小的执行单位，不允许分割。事务的原子性确保动作要么全部完成，要么完全不起作用；</p>
</li>
<li>
<p><strong>一致性</strong>（<code v-pre>Consistency</code>）：执行事务前后，数据保持一致，例如转账业务中，无论事务是否成功，转账者和收款人的总额应该是不变的；</p>
</li>
<li>
<p><strong>隔离性</strong>（<code v-pre>Isolation</code>）：并发访问数据库时，一个用户的事务不被其他事务所干扰，各并发事务之间数据库是独立的；</p>
</li>
<li>
<p><strong>持久性</strong>（<code v-pre>Durability</code>）：一个事务被提交之后。它对数据库中数据的改变是持久的，即使数据库发生故障也不应该对其有任何影响。</p>
</li>
</ul>
</div>
<p>🌈 这里要额外补充一点：<strong>只有保证了事务的持久性、原子性、隔离性之后，一致性才能得到保障。也就是说 A、I、D 是手段，C 是目的！</strong></p>
<figure><img src="/image/cloud/cloud35.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="二、spring对事务的支持" tabindex="-1"><a class="header-anchor" href="#二、spring对事务的支持"><span>二、Spring对事务的支持</span></a></h2>
<h3 id="_1、mysql-怎么保证原子性的" tabindex="-1"><a class="header-anchor" href="#_1、mysql-怎么保证原子性的"><span>1、<strong>MySQL 怎么保证原子性的？</strong></span></a></h3>
<blockquote>
...
<div class="hint-container tip">
<p class="hint-container-title">Spring 支持两种方式的事务管理</p>
<ul>
<li>编程式事务管理</li>
<li>声明式事务管理</li>
</ul>
</div>
<h3 id="_2、编程式事务管理" tabindex="-1"><a class="header-anchor" href="#_2、编程式事务管理"><span>2、编程式事务管理</span></a></h3>
<p>通过 <code v-pre>TransactionTemplate</code>或者<code v-pre>TransactionManager</code>手动管理事务，实际应用中很少使用，但是对于理解 Spring 事务管理原理有帮助。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、声明式事务管理" tabindex="-1"><a class="header-anchor" href="#_3、声明式事务管理"><span>3、声明式事务管理</span></a></h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、spring-事务管理接口介绍" tabindex="-1"><a class="header-anchor" href="#三、spring-事务管理接口介绍"><span>三、Spring 事务管理接口介绍</span></a></h2>
...
<h3 id="_1、platformtransactionmanager" tabindex="-1"><a class="header-anchor" href="#_1、platformtransactionmanager"><span>1、PlatformTransactionManager</span></a></h3>
...
<p>将事务管理行为抽象出来，然后不同的平台去实现它，这样我们可以保证提供给外部的行为不变，方便我们扩展。</p>
</div>
<h3 id="_2、transactiondefinition" tabindex="-1"><a class="header-anchor" href="#_2、transactiondefinition"><span>2、TransactionDefinition</span></a></h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、transactionstatus-事务状态" tabindex="-1"><a class="header-anchor" href="#_3、transactionstatus-事务状态"><span>3、TransactionStatus:事务状态</span></a></h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四、事务属性详解" tabindex="-1"><a class="header-anchor" href="#四、事务属性详解"><span>四、事务属性详解</span></a></h2>
<h3 id="_1、事务传播行为" tabindex="-1"><a class="header-anchor" href="#_1、事务传播行为"><span>1、事务传播行为</span></a></h3>
<ul>
<li><strong>事务传播行为是为了解决业务层方法之间互相调用的事务问题</strong>。</li>
</ul>
<p>当事务方法被另一个事务方法调用时，必须指定事务应该如何传播。例如：方法可能继续在现有事务中运行，也可能开启一个新事务，并在自己的事务中运行。</p>
<p>举个例子：我们在 A 类的<code v-pre>aMethod()</code>方法中调用了 B 类的 <code v-pre>bMethod()</code> 方法。这个时候就涉及到业务层方法之间互相调用的事务问题。如果我们的 <code v-pre>bMethod()</code>如果发生异常需要回滚，如何配置事务传播行为才能让 <code v-pre>aMethod()</code>也跟着回滚呢？这个时候就需要事务传播行为的知识了。</p>
<p>在<code v-pre>TransactionDefinition</code>定义中包括了如下几个表示传播行为的常量：</p>
...
<p>举个例子：如果 <code v-pre>bMethod()</code> 回滚的话，<code v-pre>aMethod()</code>不会回滚。如果 <code v-pre>aMethod()</code> 回滚的话，<code v-pre>bMethod()</code>会回滚。</p>
...
<h3 id="_2、事务隔离级别" tabindex="-1"><a class="header-anchor" href="#_2、事务隔离级别"><span>2、事务隔离级别</span></a></h3>
...
<p>相关阅读：<a href="https://javaguide.cn/database/mysql/transaction-isolation-level.html" target="_blank" rel="noopener noreferrer">MySQL 事务隔离级别详解</a>。</p>
<h3 id="_3、事务超时属性" tabindex="-1"><a class="header-anchor" href="#_3、事务超时属性"><span>3、事务超时属性</span></a></h3>
...
<h3 id="_4、事务只读属性" tabindex="-1"><a class="header-anchor" href="#_4、事务只读属性"><span>4、事务只读属性</span></a></h3>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">org<span class="token punctuation">.</span>springframework<span class="token punctuation">.</span>transaction</span><span class="token punctuation">;</span>
...
<p>拿 MySQL 的 innodb 举例子，根据<a href="https://dev.mysql.com/doc/refman/5.7/en/innodb-autocommit-commit-rollback.html" target="_blank" rel="noopener noreferrer">官网</a> 描述：</p>
<blockquote>
...
<div class="hint-container tip">
<p class="hint-container-title">关于事务只读属性：</p>
<ul>
...
<h3 id="_5、事务回滚规则" tabindex="-1"><a class="header-anchor" href="#_5、事务回滚规则"><span>5、事务回滚规则</span></a></h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="五、-transactional-注解使用详解" tabindex="-1"><a class="header-anchor" href="#五、-transactional-注解使用详解"><span>五、@Transactional 注解使用详解</span></a></h2>
<div class="hint-container tip">
<p class="hint-container-title">`@Transactional` 的作用范围</p>
<ol>
...
<h3 id="_1、-transactional-的常用配置参数" tabindex="-1"><a class="header-anchor" href="#_1、-transactional-的常用配置参数"><span>1、<code v-pre>@Transactional</code> 的常用配置参数</span></a></h3>
...
<div class="hint-container tip">
<p class="hint-container-title">`@Transactional` 事务注解原理</p>
...
<h3 id="_2、spring-aop-自调用问题" tabindex="-1"><a class="header-anchor" href="#_2、spring-aop-自调用问题"><span>2、Spring AOP 自调用问题</span></a></h3>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>当一个方法被标记了<code v-pre>@Transactional</code> 注解的时候，Spring 事务管理器只会在被其他类方法调用的时候生效，而不会在一个类中方法调用生效。</p>
</div>
<p>因为 Spring AOP 工作原理决定的。因为 Spring AOP 使用动态代理来实现事务的管理，它会在运行的时候为带有 <code v-pre>@Transactional</code> 注解的方法生成代理对象，并在方法调用的前后应用事物逻辑。如果该方法被其他类调用我们的代理对象就会拦截方法调用并处理事务。但是在一个类中的其他方法内部调用的时候，我们代理对象就无法拦截到这个内部调用，因此事务也就失效了。</p>
<ul>
<li>解决办法就是避免同一类中自调用或者使用 AspectJ 取代 Spring AOP 代理。</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Service</span>
...
<div class="hint-container tip">
<p class="hint-container-title">`@Transactional` 的使用注意事项总结</p>
<ul>
...
<p>[1] <a href="https://javaguide.cn/system-design/framework/spring/spring-transaction.html" target="_blank" rel="noopener noreferrer">https://javaguide.cn/system-design/framework/spring/spring-transaction.html</a></p>
<p>[2] <a href="https://www.cnblogs.com/chanshuyi/p/head-first-of-spring-transaction.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/chanshuyi/p/head-first-of-spring-transaction.html</a></p>
</div></template>
