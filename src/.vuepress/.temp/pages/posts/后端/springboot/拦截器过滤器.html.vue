<template><div><!--more--->
<h1 id="拦截器和过滤器" tabindex="-1"><a class="header-anchor" href="#拦截器和过滤器"><span>拦截器和过滤器</span></a></h1>
<h2 id="一、区别" tabindex="-1"><a class="header-anchor" href="#一、区别"><span>一、区别</span></a></h2>
...
<p>4、<strong>Filter</strong>是依<strong>赖于Servlet容</strong>器，<strong>属于Servlet规范的一部分</strong>，而<strong>拦截器则是独立存</strong>在的，可以在任何情况下使用。</p>
...
<ul>
<li>过滤器可以修改request，而拦截器不能</li>
<li>过滤器需要在servlet容器中实现，拦截器可以适用于javaEE，javaSE等各种环境</li>
<li>拦截器可以调用IOC容器中的各种依赖，而过滤器不能</li>
<li>过滤器只能在请求的前后使用，而拦截器可以详细到每个方法</li>
</ul>
</div>
<p><strong>总的来说</strong>
过滤器就是筛选出你要的东西，比如requeset中你要的那部分,拦截器在做安全方面用的比较多，比如终止一些流程</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>过滤器（Filter） ：可以拿到原始的http请求，但是拿不到你请求的控制器和请求控制器中的方法的信息。</p>
<p>拦截器（Interceptor）：可以拿到你请求的控制器和方法，却拿不到请求方法的参数。</p>
<p>切片（Aspect）: 可以拿到方法的参数，但是却拿不到http请求和响应的对象</p>
</div>
<h2 id="二、过滤器-fileter" tabindex="-1"><a class="header-anchor" href="#二、过滤器-fileter"><span>二、过滤器 Fileter</span></a></h2>
<h3 id="_1、使用" tabindex="-1"><a class="header-anchor" href="#_1、使用"><span>1、使用</span></a></h3>
<p><strong>入口函数</strong></p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ServletComponentScan</span>   <span class="token comment">//过滤器生效标记</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>过滤器类</strong></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">LoginCheckFilter</span> <span class="token keyword">implements</span> <span class="token class-name">Filter</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>fastjson依赖:</strong></p>
...
<h2 id="三、拦截器-interceptor" tabindex="-1"><a class="header-anchor" href="#三、拦截器-interceptor"><span>三、拦截器 Interceptor</span></a></h2>
<h3 id="_1、使用-1" tabindex="-1"><a class="header-anchor" href="#_1、使用-1"><span>1、使用</span></a></h3>
<p>实现拦截器可以通过继承 <code v-pre>HandlerInterceptorAdapter</code>类也可以通过实现<code v-pre>HandlerInterceptor</code>这个接口。另外，如果<code v-pre>preHandle</code>方法<code v-pre>return true</code>，则继续后续处理。</p>
...
<p>继承了<code v-pre>WebMVCConfigurerAdapter</code>，这里我们重写了<code v-pre>addInterceptors</code>这个方法，进行拦截器的配置，主要配置项就两个，一个是指定拦截器，第二个是指定拦截的URL.</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>  <span class="token comment">//配置类</span>
...
<p class="hint-container-title">拦截器不生效常见问题</p>
<ul>
<li>是否有加@Configuration</li>
<li>拦截路径是否有问题 <code v-pre>**</code> 和 <code v-pre>*</code></li>
<li>拦截器最后路径一定要 “<code v-pre>/**</code>”， 如果是目录的话则是 <code v-pre>/*/</code></li>
</ul>
</div>
<h3 id="_2、应用场景-1" tabindex="-1"><a class="header-anchor" href="#_2、应用场景-1"><span>2、应用场景</span></a></h3>
