<template><div><!--more--->
<h1 id="spring-ioc详解" tabindex="-1"><a class="header-anchor" href="#spring-ioc详解"><span>Spring IOC详解</span></a></h1>
<h2 id="一、quickly-start" tabindex="-1"><a class="header-anchor" href="#一、quickly-start"><span>一、Quickly Start</span></a></h2>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">// IOC    将当前类交给IOC容器管理，成为IOC中的bean   -控制反转</span>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code>		<span class="token comment">//1、根据bean名称获取</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>第三方Bean</strong></p>
<p>如果要管理的bean对象来自于第三方〈不是自定义的)，是无法用<code v-pre>@Component</code>及衍生注解声明bean的，就需要用到@Bean注解。</p>
<p>若要管理的第三方bean对象，建议对这些bean进行集中分类配置，可以通过<code v-pre>@Configuration</code>注解声明一个配置类。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二、spring-ioc" tabindex="-1"><a class="header-anchor" href="#二、spring-ioc"><span>二、Spring IOC</span></a></h2>
<h3 id="_1、谁控制谁" tabindex="-1"><a class="header-anchor" href="#_1、谁控制谁"><span>1、谁控制谁？</span></a></h3>
<p>在以前，对象的创建和销毁都是由用户控制的，用了ioc之后，对象的创建和销毁就都交给容器来控制了，用户就不用管这些，只关注业务需求就好了</p>
<figure><img src="/image/ioc1.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_2、什么是反转" tabindex="-1"><a class="header-anchor" href="#_2、什么是反转"><span>2、什么是反转？</span></a></h3>
<p>既然叫反转，肯定就有正转，正转其实就是对象去找实例，而反转就反过来了嘛，让实例来找对象；怎么找呢？当然是通过容器啦！</p>
<figure><img src="/image/ioc2.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_3、谁依赖谁" tabindex="-1"><a class="header-anchor" href="#_3、谁依赖谁"><span>3、谁依赖谁？</span></a></h3>
...
<figure><img src="/image/ioc3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_4、谁注入谁" tabindex="-1"><a class="header-anchor" href="#_4、谁注入谁"><span>4、谁注入谁？</span></a></h3>
<p>通过容器注入了bean对象，而且这个过程是自动化的，也就是说容器会自动找到和bean对象匹配的类型实例注入到对象中；</p>
<figure><img src="/image\ioc4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="三、spring-ioc的加载过程" tabindex="-1"><a class="header-anchor" href="#三、spring-ioc的加载过程"><span>三、spring ioc的加载过程</span></a></h2>
<p>了解完控制反转和依赖注入，接下来我们在看看ioc的加载过程，ioc的整个加载过程如下图，先看看大致的流程，然后再慢慢深入 （其中黄色的框内是注释内容）</p>
<figure><img src="/image\ioc5.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>首先，通过<code v-pre>BeanDefinitionReader</code> 读取指定的配置文件生成<code v-pre>bean</code>的定义信息，然后到完整的<code v-pre>bean</code>定义信息(<code v-pre>BeanDefinition</code>对象)，注意这里只是存储<code v-pre>bean</code>的定义信息，还没有实例化<code v-pre>bean</code>对象；就像工厂里面一样，原材料已经准备好了，但是还没有进行生产，原材料就是<code v-pre>beanDefinition</code>，生产就是实例化</li>
<li>在 <code v-pre>BeanDefinition</code> 和 完整<code v-pre>BeanDefinition</code> 中间通过一个后置增强器，可以对bean的定义信息进行统一修改，只需要实现 <code v-pre>BeanFactoryPostProcessor</code> 接口即可，这个后置增强器是可以有多个的，你只要在不同的类实现多个 <code v-pre>BeanFactoryPostProcessor</code> 接口就会执行多次，就像这样</li>
</ul>
...
<li>得到完整<code v-pre>BeanDefinition</code>之后就可以进行创建对象了，这整个过程被称为 bean 的生命周期，也就是从实例化到销毁的过程；那么这时候爱学习童鞋就要发问了：“对象创建和销毁有这么麻烦嘛？直接反射实例化一个对象不就行了嘛？为啥还有初始化？”； 首先，这是个好问题，来，我们先把掌声送给这位发问的同学；我想说的是，就算是普通的new一个对象出来，里面也会经过实例化和初始化，接下来我们重点讲bean的生命周期;</li>
</ul>
<h2 id="四、spring-bean的生命周期" tabindex="-1"><a class="header-anchor" href="#四、spring-bean的生命周期"><span>四、Spring Bean的生命周期</span></a></h2>
<p>粗略来看，bean的生命周期主要分为以下4个步骤</p>
<figure><img src="/image\ioc6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>但其实，它的内部蕴含了很多东西，让我们看看细化后的流程图；</p>
<figure><img src="/image\ioc7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>接下来我们要将1、3、4 放到一起讲，是因为它们是在同一个接口里面的，实现<code v-pre>InstantiationAwareBeanPostProcessor</code>接口即可</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">Spring<span class="token punctuation">.</span>Boot</span><span class="token punctuation">.</span>init<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1、实例化前置" tabindex="-1"><a class="header-anchor" href="#_1、实例化前置"><span>1、实例化前置</span></a></h3>
<p>实例化前置使用的是 <code v-pre>InstantiationAwareBeanPostProcessor.postProcessBeforeInstantiation(Class&lt;?&gt; beanClass, String beanName)</code> 方法，方法里有2个参数，分别是<code v-pre>beanClass</code>和<code v-pre>beanName</code>，顾名思义，就是对在对象实例化之前对bean对象的class信息进行修改或者扩展，以达到我们想要的功能，它的底层是动态代理AOP技术实现的；且是bean生命周期中最先执行的方法；</p>
<ul>
<li>
<p><strong>返回非空</strong>：返回值是Object类型，这意味着我们可以返回任何类型的值，由于这个时候目标对象还未实例化，所以这个返回值可以用来代替原本该生成对象的目标对象的实例，也就是说，如果返回了非空的值，那么以后我们需要用到这个bean的时候，拿到的就现在返回的对象了，也就不会去走第二步去实例化对象了；</p>
</li>
<li>
<p><strong>返回空（null）值</strong>：默认也是返回null值的，那么就直接返回，接下来会调用<code v-pre>doCreateBean</code>方法来实例化对象；</p>
</li>
</ul>
<h3 id="_2、实例化对象" tabindex="-1"><a class="header-anchor" href="#_2、实例化对象"><span>2、实例化对象</span></a></h3>
<p><code v-pre>doCreateBean</code>方法创建实例，用反射技术创建，这个没什么好说的，只是相当于new了一个对象出来而已，但需要注意的是，这个时候只是将对象实例化了，对象内的属性还未设置；</p>
<h3 id="_3、实例化后置" tabindex="-1"><a class="header-anchor" href="#_3、实例化后置"><span>3、实例化后置</span></a></h3>
<p><strong>方法名称</strong>： <code v-pre>InstantiationAwareBeanPostProcessor.postProcessAfterInstantiation(Object bean, String beanName)</code></p>
<p>在目标对象实例化之后调用，这个时候对象已经被实例化，但是该实例的属性还未被设置，都是null。因为他的返回值是决定要不要调用<code v-pre>postProcessPropertyValues</code>方法中的一个因素(因为还有一个因素是<code v-pre>mbd.getDependencyCheck();</code></p>
<ul>
<li>
<p><strong>返回false</strong> ：如果该方法返回false，并且不需要check，那么<code v-pre>postProcessPropertyValues</code>就会被忽略不执行；</p>
</li>
<li>
<p><strong>返回true</strong> ： 如果返回true，<code v-pre>postProcessPropertyValues</code>就会被执行</p>
</li>
</ul>
<h3 id="_4、属性修改" tabindex="-1"><a class="header-anchor" href="#_4、属性修改"><span>4、属性修改</span></a></h3>
<p><strong>方法名称</strong> ：<code v-pre>InstantiationAwareBeanPostProcessor.PropertyValues postProcessPropertyValues(PropertyValues pvs, PropertyDescriptor[] pds, Object bean, String beanName)</code></p>
<p>此方法可对属性值进行修改，修改范围包括添加、修改、删除操作；，如果实例化后置 <code v-pre>postProcessAfterInstantiation()</code> 方法返回false，那么该方法不会被调用；</p>
<h3 id="_5、给用户属性赋值" tabindex="-1"><a class="header-anchor" href="#_5、给用户属性赋值"><span>5、给用户属性赋值</span></a></h3>
<p>用户属性指的是用spring 的人自定义的bean对象属性，像 <code v-pre>User、Student、Teacher 、UserService、IndexService</code> 这类的对象都是自定义bean对象，第5步主要给这类属性进行赋值操作，使用的是 <code v-pre>AbstractAutowireCapableBeanFactory.populateBean()</code> 方法进行赋值；</p>
<h3 id="_6、给容器属性赋值" tabindex="-1"><a class="header-anchor" href="#_6、给容器属性赋值"><span>6、给容器属性赋值</span></a></h3>
<p>容器属性其实就是容器自带的属性，这些属性都是spring本来就有的；可以肯定的是，它们都是 Aware 接口的实现类，主要有以下实现类，我已经将它们的执行顺序都排列好了，</p>
<figure><img src="/image\ioc8.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>我们先看看怎么用，然后再来讲解每个Aware的作用；</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7、初始化前置" tabindex="-1"><a class="header-anchor" href="#_7、初始化前置"><span>7、初始化前置</span></a></h3>
<p><strong>方法名称</strong>： <code v-pre>BeanPostProcessor.postProcessBeforeInitialization()</code></p>
<p>在每一个 <code v-pre>Bean</code> 初始化之前执行的方法（有多少 Bean 调用多少次）</p>
<div class="hint-container caution">
<p class="hint-container-title">注意</p>
<p>启用该方法后，标注了<code v-pre>@PostConstruct</code>注解的方法会失效</p>
</div>
<h3 id="_8、初始化后置" tabindex="-1"><a class="header-anchor" href="#_8、初始化后置"><span>8、初始化后置</span></a></h3>
<p><strong>方法名称</strong>： <code v-pre>BeanPostProcessor.postProcessAfterInitialization()</code></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ExtBeanPostProcessor</span> <span class="token keyword">implements</span> <span class="token class-name">BeanPostProcessor</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9、执行初始化方法" tabindex="-1"><a class="header-anchor" href="#_9、执行初始化方法"><span>9、执行初始化方法</span></a></h3>
<div class="hint-container info">
<p class="hint-container-title">初始化方法有三个，分别是 :</p>
<ul>
<li>
<p>添加了<code v-pre>@PostConstruct</code> 注解的方法、</p>
</li>
<li>
<p>实现<code v-pre>InitializingBean</code>接口、</p>
</li>
<li>
<p>在@bean注解上添加 <code v-pre>initMethod</code>属性；</p>
</li>
</ul>
</div>
<h4 id="_1-postconstruct" tabindex="-1"><a class="header-anchor" href="#_1-postconstruct"><span>1)<code v-pre>@PostConstruct</code></span></a></h4>
<p>在bean对象内添加<code v-pre>@PostConstruct</code> 注解后即可实现初始化的功能，被<code v-pre>@PostConstruct</code>修饰的方法会在构造函数之后，<code v-pre>init()</code>方法之前运行。 有多个则会执行多次；</p>
<div class="hint-container tip">
<p class="hint-container-title">注意</p>
<p>如果spring 实现了 <code v-pre>BeanPostProcessor</code>接口的<code v-pre>postProcessBeforeInitialization()</code> 方法，也就是12的初始后置方法，那么<code v-pre>@PostConstruct</code>注解会失效；</p>
</div>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">Spring<span class="token punctuation">.</span>Boot</span><span class="token punctuation">.</span>init<span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">org<span class="token punctuation">.</span>springframework<span class="token punctuation">.</span>stereotype<span class="token punctuation">.</span></span><span class="token class-name">Component</span></span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-initializingbean-afterpropertiesset" tabindex="-1"><a class="header-anchor" href="#_2-initializingbean-afterpropertiesset"><span>2)<code v-pre>InitializingBean.afterPropertiesSet()</code></span></a></h4>
<p>spring 初始化方法之一，作用是在<code v-pre>BeanFactory</code>完成属性设置之后,执行自定义的初始化行为。</p>
<p>执行顺序：在<code v-pre>initMethod</code>之前执行，在<code v-pre>@PostConstruct</code>之后执行</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">Spring<span class="token punctuation">.</span>Boot</span><span class="token punctuation">.</span>init<span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ExtInitializingBean</span> <span class="token keyword">implements</span> <span class="token class-name">InitializingBean</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-init-method" tabindex="-1"><a class="header-anchor" href="#_3-init-method"><span>3) <code v-pre>init-method</code></span></a></h4>
<p>bean 配置文件属性 <code v-pre>init-method</code> 用于在bean初始化时指定执行方法，用来替代继承 <code v-pre>InitializingBean</code>接口,</p>
<p>注意的一点是只有一个类完整的实例被创建出来后，才能走初始化方法。</p>
<p>示例代码，先定义一个类： <code v-pre>BeanTest.java</code> ，在类中定义一个初始化方法 <code v-pre>initMethod_1()</code></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_13、使用中" tabindex="-1"><a class="header-anchor" href="#_13、使用中"><span>13、使用中</span></a></h3>
<p>到这一步，bean对象就已经完全创建好了，是一个完整对象了，并且正在被其他对象使用了；</p>
<h3 id="_14、销毁流程" tabindex="-1"><a class="header-anchor" href="#_14、销毁流程"><span>14、销毁流程</span></a></h3>
<p>在这里需要先说一下，被spring容器管理的bean默认是单例的，默认在类上面有个 @Scope注解，也就是这样的</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token comment">//@Lazy  //延迟初始化，第一次使用时创建</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果是单例模式，会先执行 <code v-pre>DisposableBean.destroy()</code>方法，然后在执行 <code v-pre>destroy-Method</code> 方法；</p>
<p>单例销毁：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_15、返回bean给用户-剩下的生命周期由用户控制" tabindex="-1"><a class="header-anchor" href="#_15、返回bean给用户-剩下的生命周期由用户控制"><span>15、返回bean给用户，剩下的生命周期由用户控制</span></a></h3>
...
<p>[1] <a href="https://juejin.cn/post/6966158157202587662" target="_blank" rel="noopener noreferrer">https://juejin.cn/post/6966158157202587662</a></p>
</div></template>
