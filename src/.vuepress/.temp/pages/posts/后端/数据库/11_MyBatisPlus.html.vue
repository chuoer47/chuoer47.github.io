<template><div><!--more--->
<h1 id="mybatisplus" tabindex="-1"><a class="header-anchor" href="#mybatisplus"><span>MyBatisPlus</span></a></h1>
<h2 id="_1、工具" tabindex="-1"><a class="header-anchor" href="#_1、工具"><span>1、工具</span></a></h2>
<p>插件：mybatisPlus</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2、快速开始" tabindex="-1"><a class="header-anchor" href="#_2、快速开始"><span>2、快速开始</span></a></h2>
<p>自定义mapper继承BaseMapper</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3、常见注解" tabindex="-1"><a class="header-anchor" href="#_3、常见注解"><span>3、常见注解</span></a></h2>
...
<h3 id="_1-tablename" tabindex="-1"><a class="header-anchor" href="#_1-tablename"><span>1） @TableName</span></a></h3>
<p>表名注解，标识实体类对应的表</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@TableName</span><span class="token punctuation">(</span><span class="token string">"user"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">User</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token class-name">Long</span> id<span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token class-name">String</span> name<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-tableid" tabindex="-1"><a class="header-anchor" href="#_2-tableid"><span>2）@TableId</span></a></h3>
<p>主键注解，标识实体类中的主键字段</p>
<p><code v-pre>TableId</code>注解支持两个属性：value  、type (默认：IdType.NONE)</p>
<p>IdType:</p>
<p>这里比较常见的有三种：</p>
<ul>
...
<h3 id="_3-tablefield" tabindex="-1"><a class="header-anchor" href="#_3-tablefield"><span>3）@TableField</span></a></h3>
<p>普通字段注解</p>
<p>一般情况下我们并不需要给字段添加<code v-pre>@TableField</code>注解，一些特殊情况除外：</p>
<ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、条件构造器" tabindex="-1"><a class="header-anchor" href="#_4、条件构造器"><span>4、条件构造器</span></a></h2>
...
<p>参数中的<code v-pre>Wrapper</code>就是条件构造的抽象类，其下有很多默认实现</p>
<div class="language-mermaid line-numbers-mode" data-ext="mermaid" data-title="mermaid"><pre v-pre class="language-mermaid"><code><span class="token keyword">graph</span> TD
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-querywrapper" tabindex="-1"><a class="header-anchor" href="#_1-querywrapper"><span>1)QueryWrapper</span></a></h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-updatewrapper" tabindex="-1"><a class="header-anchor" href="#_2-updatewrapper"><span>2)UpdateWrapper</span></a></h3>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-lambdaquerywrapper" tabindex="-1"><a class="header-anchor" href="#_3-lambdaquerywrapper"><span>3)LambdaQueryWrapper</span></a></h3>
<p>无论是QueryWrapper还是UpdateWrapper在构造条件的时候都需要写死字段名称，会出现字符串<code v-pre>魔法值</code>。这在编程规范中显然是不推荐的</p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">void</span> <span class="token function">testLambdaQueryWrapper</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    users<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token operator">::</span><span class="token function">println</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5、自定义sql" tabindex="-1"><a class="header-anchor" href="#_5、自定义sql"><span>5、自定义SQL</span></a></h2>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6、service接口" tabindex="-1"><a class="header-anchor" href="#_6、service接口"><span>6、Service接口</span></a></h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，编写<code v-pre>UserServiceImpl</code>类，继承<code v-pre>ServiceImpl</code>，实现<code v-pre>UserService</code></p>
...
<span class="token punctuation">{</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="基于lambda查询" tabindex="-1"><a class="header-anchor" href="#基于lambda查询"><span><strong>基于Lambda查询</strong></span></a></h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>与lambdaQuery方法类似，IService中的lambdaUpdate方法可以非常方便的实现复杂更新业务</p>
<h4 id="mysql批量新增" tabindex="-1"><a class="header-anchor" href="#mysql批量新增"><span><strong>MySQL批量新增</strong></span></a></h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7、静态工具" tabindex="-1"><a class="header-anchor" href="#_7、静态工具"><span>7、静态工具</span></a></h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8、逻辑删除" tabindex="-1"><a class="header-anchor" href="#_8、逻辑删除"><span>8、逻辑删除</span></a></h2>
...
<p>先给<code v-pre>address</code>表添加一个逻辑删除字段</p>
<p>然后给<code v-pre>Address</code>实体添加<code v-pre>deleted</code>字段：</p>
<p>接下来，我们要在<code v-pre>application.yml</code>中配置逻辑删除字段</p>
<div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">mybatis-plus</span><span class="token punctuation">:</span>
...
<h2 id="_9、通用枚举" tabindex="-1"><a class="header-anchor" href="#_9、通用枚举"><span>9、通用枚举</span></a></h2>
<p>User类中字段 status</p>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token class-name">UserStatus</span> status<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>要让<code v-pre>MybatisPlus</code>处理枚举与数据库类型自动转换，我们必须告诉<code v-pre>MybatisPlus</code>，枚举中的哪个字段的值作为数据库值。 <code v-pre>MybatisPlus</code>提供了<code v-pre>@EnumValue</code>注解来标记枚举属性。 在UserStatus枚举中通过<code v-pre>@JsonValue</code>注解标记JSON序列化时展示的字段</p>
<p><strong>配置枚举处理器</strong></p>
<div class="language-YAML line-numbers-mode" data-ext="YAML" data-title="YAML"><pre v-pre class="language-YAML"><code>mybatis-plus:
  configuration:
    default-enum-type-handler: com.baomidou.mybatisplus.core.handlers.MybatisEnumTypeHandler
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_10、json处理器" tabindex="-1"><a class="header-anchor" href="#_10、json处理器"><span>10、JSON处理器</span></a></h2>
<p>数据库的user表中有一个<code v-pre>info</code>字段，是JSON类型，而目前<code v-pre>User</code>实体类中却是<code v-pre>String</code>类型</p>
...
<p>首先定义一个单独实体类来与info字段的属性匹配，接下来，将User类的info字段修改为UserInfo类型，并声明类型处理器</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_11、分页" tabindex="-1"><a class="header-anchor" href="#_11、分页"><span>11、分页</span></a></h2>
...
<h3 id="_1-配置分页插件" tabindex="-1"><a class="header-anchor" href="#_1-配置分页插件"><span>1）<strong>配置分页插件</strong></span></a></h3>
<p>新建一个配置类：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MybatisConfig</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-分页api" tabindex="-1"><a class="header-anchor" href="#_2-分页api"><span>2)<strong>分页</strong>API</span></a></h3>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
