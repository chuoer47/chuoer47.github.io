<template><div><!--more--->
<h1 id="服务保护" tabindex="-1"><a class="header-anchor" href="#服务保护"><span>服务保护</span></a></h1>
...
<h2 id="二、解决方案" tabindex="-1"><a class="header-anchor" href="#二、解决方案"><span>二、解决方案</span></a></h2>
<div class="hint-container info">
<p class="hint-container-title">微服务保护方案</p>
<ul>
<li>请求限流</li>
<li>线程隔离</li>
<li>服务熔断</li>
...
<p>这些方案或多或少都会导致服务的体验上略有下降，比如:</p>
<ul>
<li>
<p>请求限流，降低了并发上限；线程隔离，降低了可用资源数量；</p>
</li>
<li>
<p>服务熔断，降低了服务的完整度，部分服务变的不可用或弱可用。</p>
</li>
</ul>
<p>因此这些方案都属于服务<strong>降级</strong>的方案。但通过这些方案，服务的健壮性得到了提升，</p>
<h3 id="_1、请求限流" tabindex="-1"><a class="header-anchor" href="#_1、请求限流"><span>1、请求限流</span></a></h3>
...
<h3 id="_2、线程隔离" tabindex="-1"><a class="header-anchor" href="#_2、线程隔离"><span>2、线程隔离</span></a></h3>
...
<h3 id="_3、服务熔断" tabindex="-1"><a class="header-anchor" href="#_3、服务熔断"><span>3、服务熔断</span></a></h3>
...
<h2 id="三、sentinel" tabindex="-1"><a class="header-anchor" href="#三、sentinel"><span>三、Sentinel</span></a></h2>
<p>微服务保护的技术有很多，但在目前国内使用较多的还是Sentinel。</p>
<h3 id="_1、介绍和安装" tabindex="-1"><a class="header-anchor" href="#_1、介绍和安装"><span>1、介绍和安装</span></a></h3>
<p>Sentinel是阿里巴巴开源的一款服务保护框架，目前已经加入SpringCloudAlibaba中，<a href="https://sentinelguard.io/zh-cn/" target="_blank" rel="noopener noreferrer">官方网站</a></p>
<div class="hint-container tip">
<p class="hint-container-title">Sentinel 的使用可以分为两个部分:</p>
<ul>
...
<p>下载地址：<a href="https://github.com/alibaba/Sentinel/releases" target="_blank" rel="noopener noreferrer">https://github.com/alibaba/Sentinel/releases</a></p>
<p><strong>2）运行</strong></p>
<p>将jar包放在任意非中文、不包含特殊字符的目录下，重命名为<code v-pre>sentinel-dashboard.jar</code></p>
<p>然后运行如下命令启动控制台：</p>
<div class="language-Shell line-numbers-mode" data-ext="Shell" data-title="Shell"><pre v-pre class="language-Shell"><code>java -Dserver.port=8090 -Dcsp.sentinel.dashboard.server=localhost:8090 -Dproject.name=sentinel-dashboard -jar sentinel-dashboard.jar
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>其它启动时可配置参数可参考<a href="https://github.com/alibaba/Sentinel/wiki/%E5%90%AF%E5%8A%A8%E9%85%8D%E7%BD%AE%E9%A1%B9" target="_blank" rel="noopener noreferrer">官方文档</a></p>
<p><strong>3）访问</strong></p>
<p>访问<a href="http://localhost:8080" target="_blank" rel="noopener noreferrer">http://localhost:8090</a>页面，就可以看到sentinel的控制台了：</p>
<center><img src="/image/cloud/cloud11.png" /></center>
<p>需要输入账号和密码，默认都是：sentinel 。登录后，即可看到控制台，默认会监控sentinel-dashboard服务本身</p>
<h3 id="_2、微服务整合" tabindex="-1"><a class="header-anchor" href="#_2、微服务整合"><span>2、微服务整合</span></a></h3>
<p>我们在<code v-pre>cart-service</code>模块中整合sentinel，连接<code v-pre>sentinel-dashboard</code>控制台，步骤如下：</p>
<p><strong>1）引入sentinel依赖</strong></p>
<div class="language-XML line-numbers-mode" data-ext="XML" data-title="XML"><pre v-pre class="language-XML"><code>&lt;!--sentinel--&gt;
&lt;dependency&gt;
    &lt;groupId&gt;com.alibaba.cloud&lt;/groupId&gt; 
    &lt;artifactId&gt;spring-cloud-starter-alibaba-sentinel&lt;/artifactId&gt;
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2）配置控制台</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>3）访问<code v-pre>cart-service</code>的任意端点</strong></p>
<p>重启<code v-pre>cart-service</code>，然后访问查询购物车接口，sentinel的客户端就会将服务访问的信息提交到<code v-pre>sentinel-dashboard</code>控制台。并展示出统计信息：</p>
<h3 id="_3、簇点链路" tabindex="-1"><a class="header-anchor" href="#_3、簇点链路"><span>3、簇点链路</span></a></h3>
<p>簇点链路，就是单机调用链路，是一次请求进入服务后经过的每一个被<code v-pre>Sentinel</code>监控的资源。默认情况下，<code v-pre>Sentinel</code>会监控<code v-pre>SpringMVC</code>的每一个<code v-pre>Endpoint</code>（接口）。因此，我们看到<code v-pre>/carts</code>这个接口路径就是其中一个簇点，我们可以对其进行限流、熔断、隔离等保护措施。</p>
<p>不过，需要注意的是，我们的SpringMVC接口是按照Restful风格设计，因此购物车的查询、删除、修改等接口全部都是<code v-pre>/carts</code>路径：</p>
<p>默认情况下Sentinel会把路径作为簇点资源的名称，无法区分路径相同但请求方式不同的接口，查询、删除、修改等都被识别为一个簇点资源，这显然是不合适的。</p>
<p>所以我们可以选择打开Sentinel的请求方式前缀，把<code v-pre>请求方式 + 请求路径</code>作为簇点资源名：</p>
<p>首先，在<code v-pre>cart-service</code>的<code v-pre>application.yml</code>中添加下面的配置：</p>
<div class="language-YAML line-numbers-mode" data-ext="YAML" data-title="YAML"><pre v-pre class="language-YAML"><code>spring:
  cloud:
    sentinel:
      transport:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，重启服务，通过页面访问购物车的相关接口，可以看到sentinel控制台的簇点链路发生了变化。</p>
<h3 id="_4、请求限流" tabindex="-1"><a class="header-anchor" href="#_4、请求限流"><span>4、请求限流</span></a></h3>
<p>在簇点链路后面点击流控按钮，即可对其做限流配置，在弹出的菜单中这样填写：</p>
<figure><img src="/image/cloud/cloud12.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>这样就把查询购物车列表这个簇点资源的流量限制在了每秒6个，也就是最大QPS为6.</p>
<h3 id="_5、线程隔离" tabindex="-1"><a class="header-anchor" href="#_5、线程隔离"><span>5、线程隔离</span></a></h3>
...
<center><img src="/image/cloud/cloud9.png"  style="zoom:50%;" /></center>
<p>这样，即便商品服务出现故障，最多导致查询购物车业务故障，并且可用的线程资源也被限定在一定范围，不会导致整个购物车服务崩溃。所以，我们要对查询商品的FeignClient接口做线程隔离。</p>
<p><strong>1）OpenFeign整合Sentinel</strong></p>
<p>修改cart-service模块的application.yml文件，开启Feign的sentinel功能：</p>
<div class="language-YAML line-numbers-mode" data-ext="YAML" data-title="YAML"><pre v-pre class="language-YAML"><code>feign:
  sentinel:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后重启cart-service服务，可以看到查询商品的FeignClient自动变成了一个簇点资源。</p>
<figure><img src="/image/cloud/cloud13.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><strong>2）配置线程隔离</strong></p>
<p>接下来，点击查询商品的FeignClient对应的簇点资源后面的流控按钮，在弹出的表单中填写下面内容：</p>
<figure><img src="/image/cloud/cloud14.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><strong>注意：</strong> 这里勾选的是并发线程数限制，也就是说这个查询功能最多使用5个线程，而不是5QPS。如果查询商品的接口每秒处理2个请求，则5个线程的实际QPS在10左右，而超出的请求自然会被拒绝。</p>
<h3 id="_6、服务熔断" tabindex="-1"><a class="header-anchor" href="#_6、服务熔断"><span>6、服务熔断</span></a></h3>
<p>我们利用线程隔离对查询购物车业务进行隔离，保护了购物车服务的其它接口。由于查询商品的功能耗时较高（我们模拟了500毫秒延时），再加上线程隔离限定了线程数为5，导致接口吞吐能力有限，最终QPS只有10左右。这就导致了几个问题：</p>
...
<p><strong>步骤一</strong>：在hm-api模块中给<code v-pre>ItemClient</code>定义降级处理类，实现<code v-pre>FallbackFactory</code>：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ItemClientFallback</span> <span class="token keyword">implements</span> <span class="token class-name">FallbackFactory</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">ItemClient</span><span class="token punctuation">></span></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>步骤二</strong>：在<code v-pre>hm-api</code>模块中的<code v-pre>com.hmall.api.config.DefaultFeignConfig</code>类中将<code v-pre>ItemClientFallback</code>注册为一个<code v-pre>Bean</code></p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code>	<span class="token annotation punctuation">@Bean</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>步骤三</strong>：在<code v-pre>hm-api</code>模块中的<code v-pre>ItemClient</code>接口中使用<code v-pre>ItemClientFallbackFactory</code>：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启后，再次测试，发现被限流的请求不再报错，走了降级逻辑。</p>
<p><strong>2）服务熔断</strong></p>
...
<figure><img src="/image/cloud/cloud15.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container info">
<p class="hint-container-title">状态机包括三个状态：</p>
<ul>
...
<p>我们可以在控制台通过点击簇点后的 <strong><code v-pre>熔断</code></strong> 按钮来配置熔断策略：</p>
<figure><img src="/image/cloud/cloud16.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
