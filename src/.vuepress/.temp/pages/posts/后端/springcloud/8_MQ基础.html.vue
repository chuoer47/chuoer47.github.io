<template><div><!--more--->
<h1 id="mq基础" tabindex="-1"><a class="header-anchor" href="#mq基础"><span>MQ基础</span></a></h1>
<h2 id="一、异步通讯" tabindex="-1"><a class="header-anchor" href="#一、异步通讯"><span>一、异步通讯</span></a></h2>
...
<figure><img src="/image/cloud/cloud21.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<p>如果我们的业务需要实时得到服务提供方的响应，则应该选择同步通讯（同步调用）。而如果我们追求更高的效率，并且不需要实时响应，则应该选择异步通讯（异步调用）。</p>
<h2 id="二、mq" tabindex="-1"><a class="header-anchor" href="#二、mq"><span>二、MQ</span></a></h2>
<h3 id="_1、同步调用" tabindex="-1"><a class="header-anchor" href="#_1、同步调用"><span>1、同步调用</span></a></h3>
<p>之前说过，我们现在基于OpenFeign的调用都属于是同步调用，那么这种方式存在哪些问题呢？</p>
<figure><img src="/image/cloud/cloud22.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<li><strong>性能下降</strong>  最终整个业务的响应时长就是每次远程调用的执行时长之和</li>
<li><strong>级联失败</strong> 由于我们是基于OpenFeign调用交易服务、通知服务。当交易服务、通知服务出现故障时，整个事务都会回滚，交易失败。</li>
</ul>
</div>
<p>而要解决这些问题，我们就必须用<strong>异步调用</strong>的方式来代替<strong>同步调用</strong>。</p>
<h3 id="_2、异步调用" tabindex="-1"><a class="header-anchor" href="#_2、异步调用"><span>2、异步调用</span></a></h3>
...
<figure><img src="/image/cloud/cloud23.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>在异步调用中，发送者不再直接同步调用接收者的业务接口，而是发送一条消息投递给消息Broker。然后接收者根据自己的需求从消息Broker那里订阅消息。每当发送方发送消息后，接受者都能获取消息并处理。这样，发送消息的人和接收消息的人就完全解耦了。</p>
<figure><img src="/image/cloud/cloud24.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="/image/cloud/cloud25.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container tip">
<p class="hint-container-title">异步调用的优势包括：</p>
<ul>
<li>耦合度更低</li>
<li>性能更好</li>
<li>业务拓展性强</li>
...
<h2 id="三、技术选型" tabindex="-1"><a class="header-anchor" href="#三、技术选型"><span>三、技术选型</span></a></h2>
<h3 id="_1、常见mq介绍" tabindex="-1"><a class="header-anchor" href="#_1、常见mq介绍"><span>1、常见MQ介绍</span></a></h3>
<p>消息Broker，目前常见的实现方案就是消息队列（MessageQueue），简称为MQ.</p>
<div class="hint-container info">
<p class="hint-container-title">目比较常见的MQ实现：</p>
<ul>
<li>ActiveMQ</li>
<li>RabbitMQ</li>
<li>RocketMQ</li>
...
<p>几种常见MQ的对比：</p>
<figure><img src="/image\cloud\cloud26.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container tip">
...
<h3 id="_2、rabbitmq" tabindex="-1"><a class="header-anchor" href="#_2、rabbitmq"><span>2、RabbitMQ</span></a></h3>
<p>我们同样基于Docker来安装RabbitMQ，使用下面的命令即可：</p>
<div class="language-Shell line-numbers-mode" data-ext="Shell" data-title="Shell"><pre v-pre class="language-Shell"><code>docker run \
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到在安装命令中有两个映射的端口：</p>
<ul>
<li>15672：RabbitMQ提供的管理控制台的端口</li>
<li>5672：RabbitMQ的消息发送处理接口</li>
</ul>
<p>RabbitMQ对应的架构如图：</p>
<figure><img src="/image\cloud\cloud27.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container tip">
<p class="hint-container-title">其中包含几个概念：</p>
<ul>
<li><strong><code v-pre>publisher</code></strong>：生产者，也就是发送消息的一方</li>
<li><strong><code v-pre>consumer</code></strong>：消费者，也就是消费消息的一方</li>
<li><strong><code v-pre>queue</code></strong>：队列，存储消息。生产者投递的消息会暂存在消息队列中，等待消费者处理</li>
<li><strong><code v-pre>exchange</code></strong>：交换机，负责消息路由。生产者发送的消息由交换机决定投递到哪个队列。</li>
<li><strong><code v-pre>virtual host</code></strong>：虚拟主机，起到数据隔离的作用。每个虚拟主机相互独立，有各自的exchange、queue</li>
</ul>
</div>
<p><strong>上述这些东西都可以在RabbitMQ的管理控制台来管理</strong></p>
<h2 id="四、springamqp" tabindex="-1"><a class="header-anchor" href="#四、springamqp"><span>四、SpringAMQP</span></a></h2>
<h3 id="_1、介绍" tabindex="-1"><a class="header-anchor" href="#_1、介绍"><span>1、介绍</span></a></h3>
<p>由于<code v-pre>RabbitMQ</code>采用了AMQP协议，因此它具备跨语言的特性。任何语言只要遵循AMQP协议收发消息，都可以与<code v-pre>RabbitMQ</code>交互。并且<code v-pre>RabbitMQ</code>官方也提供了各种不同语言的客户端。</p>
<p>Spring的官方刚好基于RabbitMQ提供了这样一套消息收发的模板工具：SpringAMQP。并且还基于SpringBoot对其实现了自动装配。<a href="https://spring.io/projects/spring-amqp" target="_blank" rel="noopener noreferrer">官方地址</a></p>
<div class="hint-container info">
<p class="hint-container-title">SpringAMQP提供了三个功能：</p>
<ul>
...
<h3 id="_2、使用" tabindex="-1"><a class="header-anchor" href="#_2、使用"><span>2、使用</span></a></h3>
<p><strong>1）导入依赖</strong></p>
<div class="language-xml line-numbers-mode" data-ext="xml" data-title="xml"><pre v-pre class="language-xml"><code> 		<span class="token comment">&lt;!--AMQP依赖，包含RabbitMQ--></span>
        ...
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2）消息发送</strong></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>3）消息接收</strong></p>
...
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>package com.itheima.consumer.listener;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、workqueues模型" tabindex="-1"><a class="header-anchor" href="#_3、workqueues模型"><span>3、WorkQueues模型</span></a></h3>
<p><code v-pre>Work queues</code>，任务模型。简单来说就是<strong>让多个消费者绑定到一个队列，共同消费队列中的消息</strong>。</p>
<figure><img src="/image\cloud\cloud28.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>当消息处理比较耗时的时候，可能生产消息的速度会远远大于消息的消费速度。长此以往，消息就会堆积越来越多，无法及时处理。此时就可以使用work 模型，<strong>多个消费者共同处理消息处理，消息处理的速度就能大大提高</strong>了。</p>
<h4 id="_1-模拟多个消息接收者" tabindex="-1"><a class="header-anchor" href="#_1-模拟多个消息接收者"><span><strong>1）模拟多个消息接收者</strong></span></a></h4>
<p>要模拟多个消费者绑定同一个队列，我们在consumer服务的SpringRabbitListener中添加2个新的方法：</p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>@RabbitListener(queues = &quot;work.queue&quot;)
...
<h4 id="_2-启动测试" tabindex="-1"><a class="header-anchor" href="#_2-启动测试"><span><strong>2）启动测试</strong></span></a></h4>
<p>发现消费者1和消费者2竟然每人消费了25条消息，也就是说消息是<strong>平均分配给每个消费者</strong>，并没有考虑到消费者的处理能力。导致1个消费者空闲，另一个消费者忙的不可开交。<strong>没有充分利用每一个消费者的能力</strong>，最终消息处理的耗时远远超过了1秒。这样显然是有问题的。</p>
<h4 id="_3-解决方案-能者多劳" tabindex="-1"><a class="header-anchor" href="#_3-解决方案-能者多劳"><span><strong>3）解决方案--能者多劳</strong></span></a></h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次测试发现由于消费者1处理速度较快，所以处理了更多的消息；消费者2处理速度较慢，只处理了6条消息。而最终总的执行耗时也在1秒左右，大大提升。正所谓能者多劳，这样充分利用了每一个消费者的处理能力，可以有效避免消息积压问题。</p>
<h4 id="_4-总结" tabindex="-1"><a class="header-anchor" href="#_4-总结"><span><strong>4）总结</strong></span></a></h4>
<p>Work模型的使用：</p>
<ul>
<li>多个消费者绑定到一个队列，同一条消息只会被一个消费者处理</li>
<li>通过设置prefetch来控制消费者预取的消息数量</li>
</ul>
<h2 id="五、交换机类型" tabindex="-1"><a class="header-anchor" href="#五、交换机类型"><span>五、交换机类型</span></a></h2>
<p>在之前的两个测试案例中，都没有交换机，生产者直接发送消息到队列。而一旦引入交换机，消息发送的模式会有很大变化：</p>
<figure><img src="/image\cloud\cloud29.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<div class="hint-container tip">
<p class="hint-container-title">交换机的类型有四种：</p>
<ul>
...
<h3 id="_1、fanout交换机" tabindex="-1"><a class="header-anchor" href="#_1、fanout交换机"><span>1、Fanout交换机</span></a></h3>
<p><code v-pre>Fanout</code>，英文翻译是扇出，我觉得在MQ中叫<strong>广播</strong>更合适。</p>
<p>在广播模式下，消息发送流程是这样的：</p>
<figure><img src="/image\cloud\cloud30.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>1）  可以有多个队列</li>
...
<h3 id="_2、direct交换机" tabindex="-1"><a class="header-anchor" href="#_2、direct交换机"><span>2、Direct交换机</span></a></h3>
<p>在Fanout模式中，一条消息，会被所有订阅的队列都消费。但是，在某些场景下，我们希望不同的消息被不同的队列消费。这时就要用到Direct类型的Exchange。</p>
<figure><img src="/image\cloud\cloud31.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<div class="hint-container tip">
<p class="hint-container-title">Direct交换机与Fanout交换机的差异？</p>
<ul>
...
<h3 id="_3、topic交换机" tabindex="-1"><a class="header-anchor" href="#_3、topic交换机"><span>3、Topic交换机</span></a></h3>
<p><code v-pre>Topic</code>类型的<code v-pre>Exchange</code>与<code v-pre>Direct</code>相比，都是可以根据<code v-pre>RoutingKey</code>把消息路由到不同的队列。</p>
<p>只不过<code v-pre>Topic</code>类型<code v-pre>Exchange</code>可以让队列在绑定<code v-pre>BindingKey</code> 的时候使用通配符！</p>
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>BindingKey` 一般都是有一个或多个单词组成，多个单词之间以`.`分割，例如： `item.insert
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container info">
<p class="hint-container-title">通配符规则：</p>
<ul>
<li><code v-pre>#</code>：匹配一个或多个词</li>
<li><code v-pre>*</code>：匹配恰好1个词</li>
</ul>
</div>
<p>举例：</p>
<ul>
...
<div class="hint-container tip">
<p class="hint-container-title">Direct交换机与Topic交换机的差异？</p>
<ul>
<li>Topic交换机接收的消息RoutingKey必须是多个单词，以 <strong><code v-pre>.</code></strong> 分割</li>
<li>Topic交换机与队列绑定时的bindingKey可以指定通配符</li>
<li><code v-pre>#</code>：代表0个或多个词</li>
<li><code v-pre>*</code>：代表1个词</li>
</ul>
</div>
<h2 id="六、声明队列和交换机" tabindex="-1"><a class="header-anchor" href="#六、声明队列和交换机"><span>六、声明队列和交换机</span></a></h2>
<p>在之前我们都是基于RabbitMQ控制台来创建队列、交换机，在这个过程中是很容易出现错误的。</p>
<p>因此推荐的做法是由程序启动时检查队列和交换机是否存在，如果不存在自动创建。</p>
<h3 id="_1、基本api" tabindex="-1"><a class="header-anchor" href="#_1、基本api"><span>1、基本API</span></a></h3>
<p>SpringAMQP提供了一个Queue类，用来创建队列：</p>
<figure><img src="/image\cloud\cloud32.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>SpringAMQP还提供了一个Exchange接口，来表示所有不同类型的交换机：</p>
<figure><img src="/image\cloud\cloud33.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>我们可以自己创建队列和交换机，不过SpringAMQP还提供了<code v-pre>ExchangeBuilder</code>来简化这个过程,而在绑定队列和交换机时，则需要使用<code v-pre>BindingBuilder</code>来创建Binding对象。</p>
<h3 id="_2、示例" tabindex="-1"><a class="header-anchor" href="#_2、示例"><span>2、示例</span></a></h3>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FanoutConfig</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于direct模式要绑定多个KEY，使用这种方式会非常麻烦，每一个Key都要编写一个binding</p>
<h3 id="_3、基于注解声明" tabindex="-1"><a class="header-anchor" href="#_3、基于注解声明"><span>3、基于注解声明</span></a></h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="七、消息转换器" tabindex="-1"><a class="header-anchor" href="#七、消息转换器"><span>七、消息转换器</span></a></h2>
<p>Spring的消息发送代码接收的消息体是一个Object，而在数据传输时，它会把你发送的消息序列化为字节发送给MQ，接收消息的时候，还会把字节反序列化为Java对象。</p>
...
<h3 id="_1、配置json转换器" tabindex="-1"><a class="header-anchor" href="#_1、配置json转换器"><span>1、配置JSON转换器</span></a></h3>
...
<p>如果项目中引入了<code v-pre>spring-boot-starter-web</code>依赖，则无需再次引入<code v-pre>Jackson</code>依赖。</p>
</div>
...
<h2 id="八、业务改造" tabindex="-1"><a class="header-anchor" href="#八、业务改造"><span>八、业务改造</span></a></h2>
<p>案例需求：改造余额支付功能，将支付成功后基于OpenFeign的交易服务的更新订单状态接口的同步调用，改为基于RabbitMQ的异步通知。</p>
<p>如图：</p>
<figure><img src="/image\cloud\cloud34.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>说明：目前没有通知服务和积分服务，因此我们只关注交易服务</p>
<div class="hint-container info">
<p class="hint-container-title">步骤如下：</p>
<ul>
<li>定义<code v-pre>direct</code>类型交换机，命名为<code v-pre>pay.direct</code></li>
<li>定义消息队列，命名为<code v-pre>trade.pay.success.queue</code></li>
<li>将<code v-pre>trade.pay.success.queue</code>与<code v-pre>pay.direct</code>绑定，<code v-pre>BindingKey</code>为<code v-pre>pay.success</code></li>
<li>支付成功时不再调用交易服务更新订单状态的接口，而是发送一条消息到<code v-pre>pay.direct</code>，发送消息的<code v-pre>RoutingKey</code>  为<code v-pre>pay.success</code>，消息内容是订单id</li>
<li>交易服务监听<code v-pre>trade.pay.success.queue</code>队列，接收到消息后更新订单状态为已支付</li>
</ul>
</div>
<h3 id="_1、配置mq" tabindex="-1"><a class="header-anchor" href="#_1、配置mq"><span>1、配置MQ</span></a></h3>
<p>不管是生产者还是消费者，都需要配置MQ的基本信息。分为两步：</p>
<p><strong>1）添加依赖：</strong></p>
<div class="language-XML line-numbers-mode" data-ext="XML" data-title="XML"><pre v-pre class="language-XML"><code>  &lt;!--消息发送--&gt;
  &lt;dependency&gt;
      &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
      &lt;artifactId&gt;spring-boot-starter-amqp&lt;/artifactId&gt;
  &lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2）配置MQ地址：</strong></p>
<div class="language-YAML line-numbers-mode" data-ext="YAML" data-title="YAML"><pre v-pre class="language-YAML"><code>spring:
  rabbitmq:
    ...
    username: hmall # 用户名
    password: 123 # 密码
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、接收消息" tabindex="-1"><a class="header-anchor" href="#_2、接收消息"><span>2、接收消息</span></a></h3>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PayStatusListener</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、发送消息" tabindex="-1"><a class="header-anchor" href="#_3、发送消息"><span>3、发送消息</span></a></h3>
...
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code> 	<span class="token comment">// 5.修改订单状态</span>
