<template><div><h1 id="xxl-job分布式任务调度" tabindex="-1"><a class="header-anchor" href="#xxl-job分布式任务调度"><span>XXL-JOB分布式任务调度</span></a></h1>
<h2 id="一、什么是分布式任务调度" tabindex="-1"><a class="header-anchor" href="#一、什么是分布式任务调度"><span>一、什么是分布式任务调度</span></a></h2>
...
<!-- more -->
<h3 id="_1、多线程方式实现" tabindex="-1"><a class="header-anchor" href="#_1、多线程方式实现"><span>1、多线程方式实现</span></a></h3>
<p>我们可以开启一个线程，每sleep一段时间，就去检查是否已到预期执行时间。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​        Timer 的优点在于简单易用，每个Timer对应一个线程，因此可以同时启动多个Timer并行执行多个任务，同一个Timer中的任务是串行执行。</p>
<p><strong>ScheduledExecutor方式实现</strong>：</p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>public static void main(String [] agrs){
...
<h3 id="_2、第三方quartz方式实现" tabindex="-1"><a class="header-anchor" href="#_2、第三方quartz方式实现"><span>2、第三方Quartz方式实现</span></a></h3>
<p>​        Quartz 是一个功能强大的任务调度框架，<a href="https://github.com/quartz-scheduler/quartz" target="_blank" rel="noopener noreferrer">项目地址</a>,它可以满足更多更复杂的调度需求，Quartz 设计的核心类包括 Scheduler, Job 以及 Trigger。</p>
<ul>
<li>
<p>其中，Job 负责定义需要执行的任务，Trigger 负责设置调度策略，Scheduler 将二者组装在一起，并触发任务开始执行。</p>
</li>
<li>
<p>Quartz支持简单的按时间间隔调度、还支持按日历调度方式，通过设置CronTrigger表达式（包括：秒、分、时、日、月、周、年）进行任务调度。</p>
</li>
</ul>
<p>下边是一个例子代码：</p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>public static void main(String [] agrs) throws SchedulerException {
    //创建一个Scheduler
...
<h3 id="_3、分布式任务调度" tabindex="-1"><a class="header-anchor" href="#_3、分布式任务调度"><span>3、分布式任务调度</span></a></h3>
...
<figure><img src="/image/cloud/cloud49.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<li>
<p><strong>2、高可用</strong>   若某一个实例宕机，不影响其他实例来执行任务。</p>
</li>
<li>
<p><strong>3、弹性扩容</strong>  当集群中增加实例就可以提高并执行任务的处理效率。</p>
</li>
<li>
<p><strong>4、任务管理与监测</strong></p>
<ul>
<li>对系统中存在的所有定时任务进行统一的管理及监测。让开发人员及运维人员能够时刻了解任务执行情况，从而做出快速的应急处理响应。</li>
</ul>
</li>
<li>
<p><strong>5、避免任务重复执行</strong></p>
<ul>
<li>当任务调度以集群方式部署，同一个任务调度可能会执行多次，比如在上面提到的电商系统中到点发优惠券的例子，就会发放多次优惠券，对公司造成很多损失，所以我们需要控制相同的任务在多个运行实例上只执行一次。</li>
</ul>
</li>
</ul>
<h2 id="二、xxl-job" tabindex="-1"><a class="header-anchor" href="#二、xxl-job"><span>二、XXL-JOB</span></a></h2>
...
<ul>
<li>
<p><a href="https://www.xuxueli.com/xxl-job/" target="_blank" rel="noopener noreferrer">官网</a></p>
</li>
<li>
<p><a href="https://www.xuxueli.com/xxl-job/#%E3%80%8A%E5%88%86%E5%B8%83%E5%BC%8F%E4%BB%BB%E5%8A%A1%E8%B0%83%E5%BA%A6%E5%B9%B3%E5%8F%B0XXL-JOB%E3%80%8B" target="_blank" rel="noopener noreferrer">文档</a></p>
</li>
</ul>
<p>XXL-JOB主要有调度中心、执行器、任务:</p>
<figure><img src="/image/cloud/cloud50.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>
...
<li>只要职责是注册服务、任务执行服务（接收到任务后会放入线程池中的任务队列）、执行结果上报、日志服务等</li>
</ul>
</li>
<li>
...
<figure><img src="/image/cloud/cloud51.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container tip">
<p class="hint-container-title">执行流程</p>
...
<h3 id="_2、搭建xxl-job" tabindex="-1"><a class="header-anchor" href="#_2、搭建xxl-job"><span>2、搭建XXL-JOB</span></a></h3>
<h4 id="_1-安装" tabindex="-1"><a class="header-anchor" href="#_1-安装"><span>1）安装</span></a></h4>
<p>首先下载XXL-JOB:</p>
<ul>
<li>
<p>GitHub：<a href="https://github.com/xuxueli/xxl-job" target="_blank" rel="noopener noreferrer">https://github.com/xuxueli/xxl-job</a></p>
</li>
<li>
<p>码云：<a href="https://gitee.com/xuxueli0323/xxl-job" target="_blank" rel="noopener noreferrer">https://gitee.com/xuxueli0323/xxl-job</a></p>
</li>
<li>
<p>项目使用2.3.1版本：<a href="https://github.com/xuxueli/xxl-job/releases/tag/2.3.1" target="_blank" rel="noopener noreferrer"> https://github.com/xuxueli/xxl-job/releases/tag/2.3.1</a></p>
</li>
</ul>
<div class="hint-container info">
<p class="hint-container-title">相关信息</p>
<p><code v-pre>xxl-job-admin</code> ：调度中心</p>
<p><code v-pre>xxl-job-core</code> ：公共依赖</p>
<p><code v-pre>xxl-job-executor-samples</code>：执行器Sample示例（选择合适的版本执行器，可直接使用）</p>
<p>​    -&gt;<code v-pre>xxl-job-executor-sample-springboot</code> ：Springboot版本，通过Springboot管理执行器，推荐这种方式；</p>
<p>​    -&gt;<code v-pre>xxl-job-executor-sample-frameless</code> ：无框架版本；</p>
<p><code v-pre>doc</code>  :文档资料，包含数据库脚本</p>
</div>
<div class="hint-container important">
<p class="hint-container-title">注意</p>
<p>部署之前需要现在数据库中运行doc中的数据库脚本创建数据库</p>
</div>
<p>使用docker部署：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>访问：<a href="http://localhost:8088/xxl-job-admin/" target="_blank" rel="noopener noreferrer">http://localhost:8088/xxl-job-admin/</a></p>
<p>账号和密码：admin/123456</p>
<p>如果无法使用虚拟机运行xxl-job可以在本机idea运行xxl-job调度中心。</p>
<h4 id="_2-配置执行器" tabindex="-1"><a class="header-anchor" href="#_2-配置执行器"><span>2）配置执行器</span></a></h4>
<p>下边配置执行器，执行器负责与调度中心通信接收调度中心发起的任务调度请求。</p>
<p>1、下边进入调度中心添加执行器</p>
<figure><img src="/image/cloud/cloud52.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>点击新增，填写执行器信息，appname是后边在nacos中配置xxl信息时指定的执行器的应用名。</p>
<figure><img src="/image/cloud/cloud53.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="_3-执行器" tabindex="-1"><a class="header-anchor" href="#_3-执行器"><span>3）执行器</span></a></h4>
<p>依赖：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在nacos下的media-service-dev.yaml下配置xxl-job</p>
<div class="language-YAML line-numbers-mode" data-ext="YAML" data-title="YAML"><pre v-pre class="language-YAML"><code>xxl:
  job:
    admin: 
...
<p class="hint-container-title">注意</p>
<p>配置中的appname这是执行器的应用名，port是执行器启动的端口，如果本地启动多个执行器注意端口不能重复。</p>
</div>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">XxlJobConfig</span> <span class="token punctuation">{</span>
     ...
     */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>之后准备测试执行器与调度中心是否正常通信，因为接口工程依赖了service工程，所以启动媒资管理模块的接口工程。启动后观察日志，出现<code v-pre>xxl-job registry success</code>日志表示执行器在调度中心注册成功</p>
<h3 id="_3、执行任务" tabindex="-1"><a class="header-anchor" href="#_3、执行任务"><span>3、执行任务</span></a></h3>
<p>在媒资服务service包下新建jobhandler存放任务类，下边参考示例工程编写一个任务类</p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>package com.xuecheng.media.service.jobhandler;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下边在调度中心添加任务，进入任务管理，点击新增，填写任务信息</p>
<figure><img src="/image/cloud/cloud54.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<ul>
<li>Cron表达式是一个字符串，通过它可以定义调度策略，格式：<code v-pre>{秒数} {分钟} {小时} {日期} {月份} {星期} {年份(可为空)}</code></li>
</ul>
</li>
</ul>
<ol start="2">
...
<h3 id="_4、分片广播" tabindex="-1"><a class="header-anchor" href="#_4、分片广播"><span>4、分片广播</span></a></h3>
<p>如何进行分布式任务处理呢？，我们会启动多个执行器组成一个集群，去执行任务。执行器在集群部署下调度中心有哪些路由策略呢？</p>
<p>查看xxl-job官方文档，阅读高级配置相关的内容：</p>
<div class="language-SQL line-numbers-mode" data-ext="SQL" data-title="SQL"><pre v-pre class="language-SQL"><code>高级配置：
...
<figure><img src="/image/cloud/cloud55.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<div class="hint-container tip">
<p class="hint-container-title">作业分片适用哪些场景呢？</p>
<ul>
...
public void shardingJobHandler() throws Exception {
    ...
    ....
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将media-service启动两个实例来测试分片广播</p>
<p>两个实例的在启动时注意端口不能冲突：</p>
<p>实例1 在VM options处添加：<code v-pre>-Dserver.port=63051 -Dxxl.job.executor.port=9998</code></p>
<p>实例2 在VM options处添加：<code v-pre>-Dserver.port=63050 -Dxxl.job.executor.port=9999</code></p>
</div></template>
