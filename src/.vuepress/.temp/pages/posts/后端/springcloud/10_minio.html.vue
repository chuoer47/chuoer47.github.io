<template><div><!--more--->
<h1 id="minio分布式文件系统" tabindex="-1"><a class="header-anchor" href="#minio分布式文件系统"><span>MinIO分布式文件系统</span></a></h1>
<h2 id="一、分布式文件系统" tabindex="-1"><a class="header-anchor" href="#一、分布式文件系统"><span>一、分布式文件系统</span></a></h2>
<h3 id="_1、文件系统" tabindex="-1"><a class="header-anchor" href="#_1、文件系统"><span>1、文件系统</span></a></h3>
...
<p>在已知的操作系统中，它们分别支持多种不同的文件系统。Windows 下支持 FAT、FAT32、NTFS，Linux 支持十多种的文件系统，例如：EXT2、EXT3、EXT4、NFS、NTFS等。</p>
<div class="hint-container info">
<p class="hint-container-title">问题？</p>
<p>一此短视频平台拥有大量的视频、图片，这些视频文件、图片文件该如何存储呢？如何存储可以满足互联网上海量用户的浏览。</p>
</div>
<p>通过概念可以简单理解为：一个计算机无法存储海量的文件，通过网络将若干计算机组织起来共同去存储海量的文件，去接收海量用户的请求，这些组织起来的计算机通过网络进行通信，如下图：</p>
<figure><img src="/image/cloud/cloud42.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h3 id="_2、分布式文件系统" tabindex="-1"><a class="header-anchor" href="#_2、分布式文件系统"><span>2、分布式文件系统</span></a></h3>
<h4 id="_1-nfs" tabindex="-1"><a class="header-anchor" href="#_1-nfs"><span>1）NFS</span></a></h4>
...
<figure><img src="/image/cloud/cloud43.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container important">
<p class="hint-container-title">特点：</p>
<ul>
<li>
<p>在客户端上映射NFS服务器的驱动器。</p>
</li>
<li>
<p>客户端通过网络访问NFS服务器的硬盘完全透明。</p>
</li>
</ul>
</div>
<h4 id="_2-gfs" tabindex="-1"><a class="header-anchor" href="#_2-gfs"><span>2）GFS</span></a></h4>
<p>GFS是一个可扩展的分布式文件系统，用于大型的、分布式的、对人量数据进行访问的应用。它运行于廉价的普通硬件上。可以提供容错功能。它可以给大量的用户提供总体性能较高的服务。</p>
<figure><img src="/image/cloud/cloud44.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container important">
<p class="hint-container-title">重要</p>
<ul>
<li>
<p>GFS采用主从结构，一个GFS集群由一个master和大量的chunkserver组成。</p>
</li>
<li>
<p>master存储了数据文件的元数据，一个文件被分成了若干块存储在多个chunkserver中。</p>
</li>
<li>
<p>用户从master中获取数据元信息，向chunkserver存储数据。</p>
</li>
</ul>
</div>
<h4 id="_3-hdfs" tabindex="-1"><a class="header-anchor" href="#_3-hdfs"><span>3）HDFS</span></a></h4>
...
<p>下图是HDFS的架构图：</p>
<figure><img src="/image/cloud/cloud45.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<div class="hint-container important">
<p class="hint-container-title">重要</p>
<ul>
<li>
<p>HDFS采用主从结构，一个HDFS集群由一个名称结点和若干数据结点组成。</p>
</li>
<li>
<p>名称结点存储数据的元信息，一个完整的数据文件分成若干块存储在数据结点。</p>
</li>
<li>
<p>客户端从名称结点获取数据的元信息及数据分块的信息，得到信息客户端即可从数据块来存取数据。</p>
</li>
</ul>
</div>
<h4 id="_4-云计算厂家" tabindex="-1"><a class="header-anchor" href="#_4-云计算厂家"><span>4）云计算厂家</span></a></h4>
<ul>
<li>
<p>阿里云对象存储服务（Object Storage Service，简称 OSS），是阿里云提供的海量、安全、低成本、高可靠的云存储服务。其数据设计持久性不低于 99.9999999999%（12 个 9），服务设计可用性（或业务连续性）不低于 99.995%。<a href="https://www.aliyun.com/product/oss" target="_blank" rel="noopener noreferrer">官方网站</a></p>
</li>
<li>
<p>百度对象存储BOS提供稳定、安全、高效、高可扩展的云存储服务。您可以将任意数量和形式的非结构化数据存入BOS，并对数据进行管理和处理。BOS支持标准、低频、冷和归档存储等多种存储类型，满足多场景的存储需求。 <a href="https://cloud.baidu.com/product/bos.html" target="_blank" rel="noopener noreferrer">官方网站</a></p>
</li>
</ul>
<h2 id="二、minio" tabindex="-1"><a class="header-anchor" href="#二、minio"><span>二、MinIO</span></a></h2>
...
<ul>
<li>
<p><a href="https://min.io" target="_blank" rel="noopener noreferrer">官网</a></p>
</li>
<li>
<p><a href="https://www.minio.org.cn/" target="_blank" rel="noopener noreferrer">中文</a></p>
</li>
</ul>
...
<figure><img src="/image/cloud/cloud46.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>Minio使用纠删码技术来保护数据，它是一种恢复丢失和损坏数据的数学算法，它将数据分块冗余的分散存储在各各节点的磁盘上，所有的可用磁盘组成一个集合。</p>
<ul>
<li>
<p>上图由8块硬盘组成一个集合，当上传一个文件时会通过纠删码算法计算对文件进行分块存储，除了将文件本身分成4个数据块，还会生成4个校验块，数据块和校验块会分散的存储在这8块硬盘上。</p>
</li>
<li>
<p>使用纠删码的好处是即便丢失一半数量（N/2）的硬盘，仍然可以恢复数据。 比如上边集合中有4个以内的硬盘损害仍可保证数据恢复，不影响上传和下载，如果多于一半的硬盘坏了则无法恢复。</p>
</li>
</ul>
<h3 id="_2、部署" tabindex="-1"><a class="header-anchor" href="#_2、部署"><span>2、部署</span></a></h3>
<p>使用docker来部署minio服务，具体步骤如下：</p>
<p><strong>1)编写docker-compose.yml文件</strong></p>
...
<p>由于只使用了一台服务器，所以使用了三个文件夹来模拟多个节点，有的版本会要求至少四个节点</p>
</div>
<p><strong>2)运行</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> compose up <span class="token parameter variable">-d</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>之后访问<a href="http://localhost:9001" target="_blank" rel="noopener noreferrer">http://localhost:9001</a> 进入UI界面。</p>
<figure><img src="/image/cloud/cloud47.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_3、sdk" tabindex="-1"><a class="header-anchor" href="#_3、sdk"><span>3、SDK</span></a></h3>
<p>MinIO提供多个语言版本SDK的支持，下边找到java版本的文档：</p>
<p>地址：<a href="https://docs.min.io/docs/java-client-quickstart-guide.html" target="_blank" rel="noopener noreferrer">https://docs.min.io/docs/java-client-quickstart-guide.html</a></p>
...
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>需要三个参数才能连接到minio服务:</p>
<ul>
<li>Endpoint    对象存储服务的URL</li>
<li>Access Key  账号</li>
<li>Secret Key  密码</li>
</ul>
<p>官方的示例代码如下：</p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>import io.minio.BucketExistsArgs;
...
<p class="hint-container-title">注意</p>
<p>创建完bucket之后要将bucket修改为public</p>
<figure><img src="/image/cloud/cloud48.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</div>
<p><strong>上传：</strong></p>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MinioTest</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行upload方法，分别测试向桶的根目录上传文件以及子目录上传文件。</p>
<p>说明：</p>
<p>设置contentType可以通过com.j256.simplemagic.ContentType枚举类查看常用的mimeType（媒体类型）</p>
<p>通过扩展名得到mimeType，代码如下：</p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>    //根据扩展名取出mimeType
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>删除文件</strong></p>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">delete</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>查询文件</strong></p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>//查询文件
@Test
public void getFile() {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>校验文件的完整性，对文件计算出md5值，比较原始文件的md5和目标文件的md5，一致则说明完整</p>
<div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre v-pre class="language-Java"><code>//校验文件的完整性对文件的内容进行md5
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、alioss" tabindex="-1"><a class="header-anchor" href="#三、alioss"><span>三、AliOSS</span></a></h2>
<h3 id="_1、什么是oss" tabindex="-1"><a class="header-anchor" href="#_1、什么是oss"><span>1、什么是OSS</span></a></h3>
<h4 id="_1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-介绍"><span>1）介绍</span></a></h4>
...
<p>如果只有存储功能，那么OSS服务就跟硬盘没啥区别了，OSS还要有外部访问的能力，这样才能把静态资源传上去（上行流量），别人才可以把这些静态资源下载下来（下行流量）。</p>
<p>总结来讲，<strong>OSS就是集存储与访问于一身的资源对象托管服务，用于存储静态资源，同时还提供备份、容灾等常见功能</strong>。</p>
<div class="hint-container tip">
<p class="hint-container-title">注意点：</p>
<ul>
<li>对象，指的是非结构化的静态资源，如图片、音频、视频、日志文件等。</li>
<li>OSS提供的服务有存储、访问、备份、容灾等。</li>
<li>OSS一般指第三方云厂商提供的对象存储服务，当然也可以自己在本地机房搭建自己的对象存储，如使用Minio等搭建分布式文件存储服务，用作对象存储。</li>
</ul>
</div>
<h4 id="_2-oss中的相关术语" tabindex="-1"><a class="header-anchor" href="#_2-oss中的相关术语"><span>2）OSS中的相关术语</span></a></h4>
<p><strong>1.存储空间（Buket）</strong></p>
<p>存储空间是用于存储对象的容器，所有的对象都存储在某个存储空间中。</p>
<p><strong>2.对象/文件（Object）</strong></p>
<p>对象是OSS存储数据的基本单元，也被称为OSS的文件，对象由元信息（Object Meta）、用户数据（Data）和文件名（Key）组成。对象由存储空间内部唯一的key来标识。</p>
<p><strong>3.地域（Region）</strong></p>
<p>地域表示OSS的数据中心所在的物理位置，可以根据费用、请求来源等来选择数据存储的地域。</p>
<p><strong>4.访问域名（Endpoint）</strong></p>
<p>Endpoint表示对外提供服务的访问域名，OSS以 HTTP restful API 对外提供服务，当访问不同地域的时候，需要不同的域名。通过内网和外网访问同一个地域所需要的域名是不同的。</p>
<p><strong>5.访问密钥（AccessKey）</strong></p>
<p>简称AK，指的是访问身份验证中用到的AccessKeyId和AccessKeySecret。OSS通过使用AccessKeyId和AccessKeySecret对称加密的方法来验证某个请求发送者的身份。AccessKeyId用来标识用户，AccessKeySecret用于加密签名字符串和OSS用来验证签名字符串的密钥，AccessKeySecret必须保密。</p>
<h3 id="_2、使用" tabindex="-1"><a class="header-anchor" href="#_2、使用"><span>2、使用</span></a></h3>
<h4 id="_1-uuid" tabindex="-1"><a class="header-anchor" href="#_1-uuid"><span>1）UUID</span></a></h4>
<p><strong>介绍</strong></p>
<p>UUID全称：Universally Unique Identifier，即通用唯一识别码。</p>
...
<p>UUID的是让分布式系统中的所有元素都能有唯一的辨识信息，而不需要通过中央控制端来做辨识信息的指定。如此一来，每个人都可以创建不与其它人冲突的UUID。在这样的情况下，就不需考虑数据库创建时的名称重复问题。目前最广泛应用的UUID，是微软公司的全局唯一标识符（GUID），而其他重要的应用，则有Linux ext2/ext3文件系统、LUKS加密分区、GNOME、KDE、Mac OS X等等。</p>
<p><strong>UUID的组成：</strong></p>
<p>UUID是指在一台机器上生成的数字，它保证对在同一时空中的所有机器都是唯一的。通常平台会提供生成的API。按照开放软件基金会(OSF)制定的标准计算，用到了以太网卡地址、纳秒级时间、芯片ID码和许多可能的数字。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_2-本地存储" tabindex="-1"><a class="header-anchor" href="#_2-本地存储"><span>2）本地存储</span></a></h4>
<div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/upload"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>配置文件</strong></p>
...
<p>[1] <a href="https://blog.csdn.net/tianjiliuhen/article/details/126954490" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/tianjiliuhen/article/details/126954490</a></p>
</div></template>
